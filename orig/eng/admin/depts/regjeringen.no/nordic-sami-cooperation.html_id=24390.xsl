...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/nordic-sami-cooperation.html_id=24390'"/>
...
<xsl:variable name="para_nob" select="'nordisk_samisk_samarbeid.html_id=24390'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'davviriikkala-sami-ovttasbargu.html_id=24390'"/>
