...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/news.html_id=884'"/>
...
<xsl:variable name="para_nno" select="'nyheiter.html_id=884'"/>
<xsl:variable name="para_nob" select="'nyheter.html_id=884'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nyheter.html_id=884'"/>
