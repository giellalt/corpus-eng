...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-information-and-communicat/Communication-Advisor.html_id=439360'"/>
...
<xsl:variable name="para_nno" select="'kommunikasjonsradgjevar-karin-johansen.html_id=439360'"/>
<xsl:variable name="para_nob" select="'kommunikasjonsradgiver-karin-johansen.html_id=439360'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinraeaddi.html_id=439360'"/>
