...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/Statistics-Norway.html_id=270407'"/>
...
<xsl:variable name="para_nno" select="'statistisk-sentralbyra.html_id=270407'"/>
<xsl:variable name="para_nob" select="'statistisk-sentralbyra.html_id=270407'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'statistihkala-guovddabyra.html_id=270407'"/>
