...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Law-and-order/Crime-and-abuse.html_id=1261'"/>
...
<xsl:variable name="para_nno" select="'kriminalitet-og-overgrep.html_id=1261'"/>
<xsl:variable name="para_nob" select="'kriminalitet_og_overgrep.html_id=1261'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vearredagolavuohta-ja-veahkavalddalavuoh.html_id=1261'"/>
