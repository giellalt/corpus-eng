...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/dep/politisk_ledelse/lahnstein_erik/el_kalender/canadas_ambassador.html_id=616341'"/>
...
<xsl:variable name="para_nno" select="'canadas_ambassador.html_id=616341'"/>
