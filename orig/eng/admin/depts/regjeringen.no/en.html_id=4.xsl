...
<xsl:variable name="filename" select="'http://regjeringen.no/en.html_id=4'"/>
...
<xsl:variable name="para_nno" select="'nn.html_id=4'"/>
<xsl:variable name="para_nob" select="'nb.html_id=4'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'se.html_id=4'"/>
