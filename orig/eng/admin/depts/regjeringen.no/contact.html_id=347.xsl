...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/contact.html_id=347'"/>
...
<xsl:variable name="para_nno" select="'kontakt.html_id=347'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=347'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oktavuoat-ja-dieut.html_id=347'"/>
