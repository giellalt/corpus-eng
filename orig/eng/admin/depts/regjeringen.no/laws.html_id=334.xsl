...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Documents/Laws-and-rules/Laws.html_id=334'"/>
...
<xsl:variable name="para_nno" select="'lover.html_id=334'"/>
<xsl:variable name="para_nob" select="'lover.html_id=334'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-.html_id=334'"/>
