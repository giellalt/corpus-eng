...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/International-relations.html_id=919'"/>
...
<xsl:variable name="para_nno" select="'internasjonalt.html_id=919'"/>
<xsl:variable name="para_nob" select="'internasjonalt.html_id=919'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riikkaidgaskasaat.html_id=919'"/>
