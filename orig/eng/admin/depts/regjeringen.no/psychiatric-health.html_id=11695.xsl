...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects/psychiatric-health.html_id=11695'"/>
...
<xsl:variable name="para_nob" select="'psykisk_helse.html_id=11695'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'psykala-dearvvavuohta.html_id=11695'"/>
