...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad.html_id=339'"/>
...
<xsl:variable name="para_nno" select="'fad.html_id=339'"/>
<xsl:variable name="para_nob" select="'fad.html_id=339'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fad.html_id=339'"/>
