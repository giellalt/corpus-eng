...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/kampanjer/the-coordination-reform.html_id=524777'"/>
...
<xsl:variable name="para_nob" select="'samhandlingsreformen.html_id=524777'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovttasdoaibmanoastus-.html_id=524777'"/>
