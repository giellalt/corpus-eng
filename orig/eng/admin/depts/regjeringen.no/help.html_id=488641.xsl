...
<xsl:variable name="filename" select="'http://regjeringen.no/en/Om-nettstedet/Help.html_id=488641'"/>
...
<xsl:variable name="para_nno" select="'hjelp.html_id=488641'"/>
<xsl:variable name="para_nob" select="'hjelp.html_id=488641'"/>
