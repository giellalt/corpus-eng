...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut/deputy-director-general-lene-lyngby.html_id=85649'"/>
...
<xsl:variable name="para_nob" select="'lene_lyngby.html_id=85649'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-lene-lyngby.html_id=85649'"/>
