...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division.html_id=85803'"/>
...
<xsl:variable name="para_nno" select="'presse--og-kommunikasjonsseksjonen.html_id=85803'"/>
<xsl:variable name="para_nob" select="'pks.html_id=85803'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassa--ja-gulahallansekuvdna-.html_id=85803'"/>
