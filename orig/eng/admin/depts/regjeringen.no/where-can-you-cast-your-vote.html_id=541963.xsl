...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/where-can-you-cast-your-vote.html_id=541963'"/>
...
<xsl:variable name="para_nno" select="'kvar-kan-du-royste.html_id=541963'"/>
<xsl:variable name="para_nob" select="'hvor-kan-du-stemme.html_id=541963'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gos-beasat-jienastit.html_id=541963'"/>
