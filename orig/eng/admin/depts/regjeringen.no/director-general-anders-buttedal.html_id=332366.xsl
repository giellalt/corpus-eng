...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/department-of-planning-administration-an/director-general-anders-buttedal.html_id=332366'"/>
...
<xsl:variable name="para_nno" select="'ekspedisjonssjef-anders-buttedahl.html_id=332366'"/>
<xsl:variable name="para_nob" select="'ekspedisjonssjef-anders-buttedahl.html_id=332366'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-anders-buttedahl.html_id=332366'"/>
