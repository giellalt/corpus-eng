...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Other-political-staff/state-secretary-hege-solbakken.html_id=582312'"/>
...
<xsl:variable name="para_nno" select="'statssekretar-hege-solbakken.html_id=582312'"/>
<xsl:variable name="para_nob" select="'statssekretar-hege-solbakken.html_id=582312'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-hege-solbakken.html_id=582312'"/>
