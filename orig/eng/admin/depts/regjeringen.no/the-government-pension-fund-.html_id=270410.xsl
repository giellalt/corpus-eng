...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/The-Government-Pension-Fund-.html_id=270410'"/>
...
<xsl:variable name="para_nno" select="'statens-pensjonsfond.html_id=270410'"/>
<xsl:variable name="para_nob" select="'statens-pensjonsfond---utland.html_id=270410'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahta-penunfoanda---olgoriikkat.html_id=270410'"/>
