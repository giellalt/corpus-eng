...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd.html_id=504'"/>
...
<xsl:variable name="para_nno" select="'krd.html_id=504'"/>
<xsl:variable name="para_nob" select="'krd.html_id=504'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'krd.html_id=504'"/>
