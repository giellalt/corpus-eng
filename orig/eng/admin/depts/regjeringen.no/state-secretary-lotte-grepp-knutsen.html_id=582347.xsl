...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/other-political-staff/state-secretary-lotte-grepp-knutsen.html_id=582347'"/>
...
<xsl:variable name="para_nno" select="'statssekretar-lotte-grepp-knutsen.html_id=582347'"/>
<xsl:variable name="para_nob" select="'statssekretar-lotte-grepp-knutsen-.html_id=582347'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-lotte-grepp-knutsen.html_id=582347'"/>
