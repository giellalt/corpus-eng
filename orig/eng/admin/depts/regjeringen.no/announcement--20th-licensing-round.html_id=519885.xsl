...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases/2008/announcement--20th-licensing-round.html_id=519885'"/>
...
<xsl:variable name="para_nob" select="'utlysning-av-20-konsesjonsrunde.html_id=519885'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'almmuhus---20-konseuvdnavuorru-.html_id=519885'"/>
