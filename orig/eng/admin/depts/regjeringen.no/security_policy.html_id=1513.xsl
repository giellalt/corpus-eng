...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy.html_id=1513'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_sikkerhetspolitikk.html_id=1513'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sihkkarvuoa-ja-lagaguovlluid-ossodat.html_id=1513'"/>
