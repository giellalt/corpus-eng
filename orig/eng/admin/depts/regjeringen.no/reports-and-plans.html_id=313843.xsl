...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Documents/Reports-and-plans.html_id=313843'"/>
...
<xsl:variable name="para_nno" select="'rapportar-og-planar.html_id=313843'"/>
<xsl:variable name="para_nob" select="'rapporter_planer.html_id=313843'"/>
