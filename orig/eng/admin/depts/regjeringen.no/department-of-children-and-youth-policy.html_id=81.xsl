...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/Department-Of-Children-and-Youth-Policy.html_id=81'"/>
...
<xsl:variable name="para_nno" select="'barne--og-ungdomsavdelinga-.html_id=81'"/>
<xsl:variable name="para_nob" select="'bua.html_id=81'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'manaid--ja-nuoraidossodat-.html_id=81'"/>
