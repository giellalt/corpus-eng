...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-marine-resources-and-envir.html_id=1582'"/>
...
<xsl:variable name="para_nno" select="'ressurs--og-havavdelinga.html_id=1582'"/>
<xsl:variable name="para_nob" select="'ressurs-_og_havavdelingen.html_id=1582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'resursa--ja-ahpeossodat.html_id=1582'"/>
