...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-organisational-and-econom/Section-for-Internal-Services-.html_id=85629'"/>
...
<xsl:variable name="para_nob" select="'internforvaltning.html_id=85629'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'siskkaldashalddaansekuvdna.html_id=85629'"/>
