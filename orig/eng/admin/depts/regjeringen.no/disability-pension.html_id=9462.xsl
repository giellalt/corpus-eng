...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/pensions/disability-pension.html_id=9462'"/>
...
<xsl:variable name="para_nob" select="'uforepensjon.html_id=9462'"/>
