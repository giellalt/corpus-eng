...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/compulsory-education.html_id=1408'"/>
...
<xsl:variable name="para_nob" select="'grunnopplaring.html_id=1408'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuooskuvla.html_id=1408'"/>
