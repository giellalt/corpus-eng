...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/the-department-of-sami-and-minority-affa.html_id=589401'"/>
...
<xsl:variable name="para_nno" select="'same--og-minoritetspolitisk-avdeling.html_id=589401'"/>
<xsl:variable name="para_nob" select="'same--og-minoritetspolitisk-avdeling.html_id=589401'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'same--og-minoritetspolitisk-avdeling.html_id=589401'"/>
