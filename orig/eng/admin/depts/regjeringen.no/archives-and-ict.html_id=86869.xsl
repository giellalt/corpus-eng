...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/administrative-department/archives-and-ict.html_id=86869'"/>
...
<xsl:variable name="para_nob" select="'arkiv.html_id=86869'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'arkiiva-ja-ikt.html_id=86869'"/>
