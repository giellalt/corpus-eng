...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/eea_efta.html_id=85977'"/>
...
<xsl:variable name="para_nob" select="'eosefta.html_id=85977'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eesefta-sekuvdna-das-maiddai-ees-allingoddi.html_id=85977'"/>
