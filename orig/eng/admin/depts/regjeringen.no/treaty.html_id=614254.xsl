...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2010/treaty.html_id=614254'"/>
...
<xsl:variable name="para_nob" select="'avtalen.html_id=614254'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'murmanskkas.html_id=614254'"/>
