...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/the-tax-administration---the-directorate.html_id=270405'"/>
...
<xsl:variable name="para_nno" select="'skatteetaten.html_id=270405'"/>
<xsl:variable name="para_nob" select="'skatteetaten.html_id=270405'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vearroetahtta---vearrodirektorahtta.html_id=270405'"/>
