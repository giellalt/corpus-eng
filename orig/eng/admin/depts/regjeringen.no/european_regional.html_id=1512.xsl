...
<xsl:variable name="para_nob" select="'eureg.html_id=1512'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'regionala-ja-ekonomala-eurohpagaaldagaid-sekuvdna-eureg.html_id=1512'"/>
