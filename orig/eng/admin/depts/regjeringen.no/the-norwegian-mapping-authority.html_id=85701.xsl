...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/the-norwegian-mapping-authority.html_id=85701'"/>
...
<xsl:variable name="para_nob" select="'statens_kartverk.html_id=85701'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stada-kartadoaimmahat.html_id=85701'"/>
