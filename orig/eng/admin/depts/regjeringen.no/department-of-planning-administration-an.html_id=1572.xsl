...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/department-of-planning-administration-an.html_id=1572'"/>
...
<xsl:variable name="para_nno" select="'plan--okonomi--og-administrasjonsavdelin.html_id=1572'"/>
<xsl:variable name="para_nob" select="'plan-_okonomi-_og_administrasjonsavdelin.html_id=1572'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'plana--ja-ekonomija--ja-halddahusossodat.html_id=1572'"/>
