...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/dep/kulturminister-anniken-huitfeldt/kulturminister-anniken-huitfeldts-kalend/Kulturministeren-deltar-pa-idrettspolitisk-konferanse.html_id=620440'"/>
...
<xsl:variable name="para_nob" select="'kulturministeren-deltar-pa-idrettspolitisk-konferanse.html_id=620440'"/>
