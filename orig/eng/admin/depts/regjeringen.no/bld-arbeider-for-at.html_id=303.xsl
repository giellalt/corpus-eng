...
<!-- Add the locations of the parallel files to the variables-->
  ...
  <xsl:variable name="para_nno" select="'om-departementet.html_id=303'"/>
  <xsl:variable name="para_nob" select="'dep.html_id=303'"/>
  <xsl:variable name="para_sma" select="''"/>
  <xsl:variable name="para_sme" select="'departemeantta-birra.html_id=303'"/>
