...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Indigenous-peoples-and-minorities.html_id=929'"/>
...
<xsl:variable name="para_nno" select="'urfolk-og-minoritetar.html_id=929'"/>
<xsl:variable name="para_nob" select="'urfolk_og_minoriteter.html_id=929'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'algoalbmogat-ja-unnitlogut.html_id=929'"/>
