...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/study-financing-.html_id=1422'"/>
...
<xsl:variable name="para_nob" select="'utdanningsfinansering.html_id=1422'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oahppodoarjja.html_id=1422'"/>
