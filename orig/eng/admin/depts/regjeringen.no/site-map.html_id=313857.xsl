...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Site-Map.html_id=313857'"/>
...
<xsl:variable name="para_nno" select="'nettstadskart.html_id=313857'"/>
<xsl:variable name="para_nob" select="'nettstedskart.html_id=313857'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'neahttakarta-.html_id=313857'"/>
