...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld.html_id=298'"/>
...
<xsl:variable name="para_nno" select="'bld.html_id=298'"/>
<xsl:variable name="para_nob" select="'bld.html_id=298'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bld.html_id=298'"/>
