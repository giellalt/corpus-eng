...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/Department-of-Planning-and-Administration.html_id=84'"/>
...
<xsl:variable name="para_nno" select="'plan--og-administrasjonsavdelinga-.html_id=84'"/>
<xsl:variable name="para_nob" select="'pla.html_id=84'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'plana--ja-halddahusossodat.html_id=84'"/>
