...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/contact.html_id=471'"/>
...
<xsl:variable name="para_nno" select="'kontakt.html_id=471'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=471'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oktavuohta.html_id=471'"/>
