...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/pensions.html_id=939'"/>
...
<xsl:variable name="para_nno" select="'pensjoner.html_id=939'"/>
<xsl:variable name="para_nob" select="'pensjoner.html_id=939'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ealahagat-.html_id=939'"/>
