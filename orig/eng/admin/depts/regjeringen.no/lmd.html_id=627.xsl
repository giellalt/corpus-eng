...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd.html_id=627'"/>
...
<xsl:variable name="para_nno" select="'lmd.html_id=627'"/>
<xsl:variable name="para_nob" select="'lmd.html_id=627'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lmd.html_id=627'"/>
