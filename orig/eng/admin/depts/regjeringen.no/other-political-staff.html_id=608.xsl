...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/About-the-Ministry/Other-political-staff.html_id=608'"/>
...
<xsl:variable name="para_nno" select="'anna-politisk-leiing.html_id=608'"/>
<xsl:variable name="para_nob" select="'politisk_ledelse.html_id=608'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eara-politihkala-njunnoat.html_id=608'"/>
