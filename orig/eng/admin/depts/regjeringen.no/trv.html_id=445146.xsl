...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/info_unit/trv.html_id=445146'"/>
...
<xsl:variable name="para_nob" select="'infosjef.html_id=445146'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinhoavda.html_id=445146'"/>
