...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister.html_id=880'"/>
...
<xsl:variable name="para_nno" select="'statsministerens-kontor-2.html_id=880'"/>
<xsl:variable name="para_nob" select="'dep.html_id=880'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaministara-kantuvra.html_id=880'"/>
