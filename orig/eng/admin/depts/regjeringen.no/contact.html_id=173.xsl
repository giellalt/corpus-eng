...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/contact.html_id=173'"/>
...
<xsl:variable name="para_nno" select="'kontakt.html_id=173'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=173'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oktavuohtadiehtojuohkin.html_id=173'"/>
