...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/About-the-Ministry/minister-of-research-and-higher-educatio.html_id=486368'"/>
...
<xsl:variable name="para_nno" select="'forskings--og-hogare-utdanningsminister-.html_id=486368'"/>
<xsl:variable name="para_nob" select="'kunnskapsminister-tora-aasland-.html_id=486368'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dutkan--ja-alitoahppoministtar-tora-aasl.html_id=486368'"/>
