...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-cultural-heritage-managem.html_id=1207'"/>
...
<xsl:variable name="para_nno" select="'avdeling-for-kulturminneforvaltning.html_id=1207'"/>
<xsl:variable name="para_nob" select="'kulturminneforvaltning.html_id=1207'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kulturmuitohalddaeami-ossodat.html_id=1207'"/>
