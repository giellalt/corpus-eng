...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/kindergarden.html_id=1029'"/>
...
<xsl:variable name="para_nob" select="'barnehager.html_id=1029'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'manaidgarddit.html_id=1029'"/>
