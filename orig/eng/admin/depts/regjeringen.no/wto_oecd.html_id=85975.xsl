...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/wto_oecd.html_id=85975'"/>
...
<xsl:variable name="para_nob" select="'wtooecd.html_id=85975'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'wtooecd-sekuvdna-.html_id=85975'"/>
