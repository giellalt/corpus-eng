...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2010/More-rental-housing-for-people-in-difficulties.html_id=604481'"/>
...
<xsl:variable name="para_nno" select="'rnb-fleire-utleigebustader-til-vanskelegstilte.html_id=604481'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanet-laigoorrunsajit-daidda-guet-leat-vattes-dilis.html_id=604481'"/>
