...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects/the-department-of-public-health/Tobacco.html_id=426168'"/>
...
<xsl:variable name="para_nob" select="'tobakk.html_id=426168'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eastadit-duhpatvigiid.html_id=426168'"/>
