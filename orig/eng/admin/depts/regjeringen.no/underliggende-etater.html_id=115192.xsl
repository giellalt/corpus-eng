...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater.html_id=115192'"/>
...
<xsl:variable name="para_nno" select="'etatar-og-verksemder.html_id=115192'"/>
<xsl:variable name="para_nob" select="'underliggende_etater.html_id=115192'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuollasa-asahusat.html_id=115192'"/>
