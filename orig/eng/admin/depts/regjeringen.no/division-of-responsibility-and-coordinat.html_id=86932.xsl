...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/midtspalte/division-of-responsibility-and-coordinat.html_id=86932'"/>
...
<xsl:variable name="para_nob" select="'ansvarsfordeling-og-samordning.html_id=86932'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovddasvastadusjuohku-ja-oktiiordnen.html_id=86932'"/>
