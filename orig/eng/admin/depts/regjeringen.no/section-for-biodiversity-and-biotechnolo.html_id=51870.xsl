...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management/section-for-biodiversity-and-biotechnolo.html_id=51870'"/>
...
<xsl:variable name="para_nob" select="'biomangfold_og_bioteknologi.html_id=51870'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bioeatnatvuoa-ja-bioteknologiija-sekuvdna.html_id=51870'"/>
