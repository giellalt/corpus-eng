...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Other-Political-Staff/roger-schjerva.html_id=272481'"/>
...
<xsl:variable name="para_nno" select="'roger-schjerva.html_id=272481'"/>
<xsl:variable name="para_nob" select="'roger-schjerva-.html_id=272481'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-roger-schjerva-.html_id=272481'"/>
