...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Subordinate-agencies-and-institutions/the-norwegian-national-coastal-administr.html_id=115310'"/>
...
<xsl:variable name="para_nno" select="'kystverket.html_id=115310'"/>
<xsl:variable name="para_nob" select="'kystverket.html_id=115310'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riddodoaimmahat-kystverket.html_id=115310'"/>
