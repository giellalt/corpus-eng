...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut/section-for-climate-change.html_id=85645'"/>
...
<xsl:variable name="para_nob" select="'klima-_og_luftforurensninger.html_id=85645'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dalkkadat--ja-aibmosekuvdna.html_id=85645'"/>
