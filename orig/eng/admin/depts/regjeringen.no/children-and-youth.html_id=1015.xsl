...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Children-and-youth.html_id=1015'"/>
...
<xsl:variable name="para_nob" select="'barn_og_ungdom.html_id=1015'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'manat-ja-nuorat.html_id=1015'"/>
