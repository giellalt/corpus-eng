...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Senior-administrative-staff/Secretary-General.html_id=115318'"/>
...
<xsl:variable name="para_nob" select="'departementsrad.html_id=115318'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantarai-jorn-krog.html_id=115318'"/>
