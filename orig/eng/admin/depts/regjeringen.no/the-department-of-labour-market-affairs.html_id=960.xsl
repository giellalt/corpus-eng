...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-labour-market-affairs.html_id=960'"/>
...
<xsl:variable name="para_nno" select="'arbeidsmarknadsavdelinga.html_id=960'"/>
<xsl:variable name="para_nob" select="'arba.html_id=960'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargomarkanossodat-.html_id=960'"/>
