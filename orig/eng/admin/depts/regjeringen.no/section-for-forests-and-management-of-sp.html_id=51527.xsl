...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management/section-for-forests-and-management-of-sp.html_id=51527'"/>
...
<xsl:variable name="para_nob" select="'artsforvaltning_og_skog.html_id=51527'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'luonddugahttema-ja-fuoohalddaeami-sekuvdna.html_id=51527'"/>
