...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/financial_markets_department.html_id=1551'"/>
...
<xsl:variable name="para_nno" select="'finansmarknadsavdelinga.html_id=1551'"/>
<xsl:variable name="para_nob" select="'finansmarkedsavdelingen.html_id=1551'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ruhtadanmarkanossodat.html_id=1551'"/>
