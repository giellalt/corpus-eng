...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Whats-new/News/2010/the-ministry-of-fisheries-and-coastal-af.html_id=610278'"/>
...
<xsl:variable name="para_nob" select="'fiskeri--og-kystdepartementet-far-ansvar.html_id=610278'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guolastus--ja-riddodepartemeanta-oau-ovd.html_id=610278'"/>
