...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/labour-market-policy/midtspalte/work-orientation.html_id=85996'"/>
...
<xsl:variable name="para_nob" select="'arbeidsretting.html_id=85996'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'barguioauheapmi---.html_id=85996'"/>
