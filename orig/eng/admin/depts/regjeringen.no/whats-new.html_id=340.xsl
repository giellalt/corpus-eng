...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/whats-new.html_id=340'"/>
...
<xsl:variable name="para_nno" select="'aktuelt.html_id=340'"/>
<xsl:variable name="para_nob" select="'aktuelt.html_id=340'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oasat.html_id=340'"/>
