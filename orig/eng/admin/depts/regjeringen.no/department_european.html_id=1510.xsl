...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european.html_id=1510'"/>
...
<xsl:variable name="para_nob" select="'europaavdelingen.html_id=1510'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eurohpa-ja-gavpeossodat.html_id=1510'"/>
