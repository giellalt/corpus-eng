...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2010/Fairer-distribution-of-income-between-the-municipalities.html_id=604562'"/>
...
<xsl:variable name="para_nno" select="'meir-rettferdig-fordeling-av-inntektene-mellom-kommunane.html_id=604562'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sisaboauid-vuoiggalat-juogadeapmi-gielddaid-gaskkas.html_id=604562'"/>
