...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/doc.html_id=270365'"/>
...
<xsl:variable name="para_nno" select="'dokument.html_id=270365'"/>
<xsl:variable name="para_nob" select="'dok.html_id=270365'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dokumeanttat-.html_id=270365'"/>
