...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/organisation-chart.html_id=406'"/>
...
<xsl:variable name="para_nno" select="'organisasjonskart.html_id=406'"/>
<xsl:variable name="para_nob" select="'organisasjonskart.html_id=406'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdnakarta.html_id=406'"/>
