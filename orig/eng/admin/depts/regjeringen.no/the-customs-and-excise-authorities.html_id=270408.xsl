...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/the-customs-and-excise-authorities.html_id=270408'"/>
...
<xsl:variable name="para_nno" select="'toll--og-avgiftsetatentollvesenet.html_id=270408'"/>
<xsl:variable name="para_nob" select="'toll--og-avgiftsetatentollvesenet.html_id=270408'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'duollo--ja-divatetahttaduollodoaimmahat.html_id=270408'"/>
