...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Law-and-order.html_id=923'"/>
...
<xsl:variable name="para_nno" select="'lov-og-rett.html_id=923'"/>
<xsl:variable name="para_nob" select="'lov_og_rett.html_id=923'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lahka-ja-riekti.html_id=923'"/>
