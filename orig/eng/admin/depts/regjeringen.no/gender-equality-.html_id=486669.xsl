...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/gender-equality-.html_id=486669'"/>
...
<xsl:variable name="para_nob" select="'likestilling-i-barnehage-utdanning-og-fo.html_id=486669'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dassearvu-manaidgarddis-oahpahusas-ja-du.html_id=486669'"/>
