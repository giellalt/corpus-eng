...
<xsl:variable name="para_nno" select="'taler-og-artiklar.html?id=638'"/>
<xsl:variable name="para_nob" select="'taler_artikler.html?id=638'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sartnit-ja-allosat.html?id=638'"/>
