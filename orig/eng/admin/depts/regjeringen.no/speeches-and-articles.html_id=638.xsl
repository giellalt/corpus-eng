...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/whats-new/Speeches-and-articles.html?id=638'"/>
...
<xsl:variable name="para_nno" select="'taler-og-artiklar.html_id=638'"/>
<xsl:variable name="para_nob" select="'taler_artikler.html_id=638'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sartnit-ja-allosat.html_id=638'"/>
