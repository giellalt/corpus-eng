...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/administrative-department/budgeting-and-finance.html_id=86862'"/>
...
<xsl:variable name="para_nob" select="'budsjett-og-okonomi.html_id=86862'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bueahtta-ja-ekonomiija.html_id=86862'"/>
