...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff/political-advisor-mina-gerhardsen.html_id=85879'"/>
...
<xsl:variable name="para_nno" select="'politisk-radgjevar-mina-gerhardsen.html_id=85879'"/>
<xsl:variable name="para_nob" select="'politisk_radgiver_mina_gerhardsen.html_id=85879'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-mina-gerhardsen.html_id=85879'"/>
