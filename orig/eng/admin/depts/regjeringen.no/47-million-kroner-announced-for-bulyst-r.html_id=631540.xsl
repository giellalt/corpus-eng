...
<xsl:variable name="para_nno" select="'47-millionar-kroner-til-bulyst-2011.html_id=631540'"/>
<xsl:variable name="para_nob" select="'nordmenns-netthandel-pa-europatoppen.html_id=631527'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'47-miljovnna-kruvnno-assanmoktii-2011.html_id=631540'"/>
