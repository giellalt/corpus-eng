...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2008/Broad-agreement-to-boost-national-climat.html_id=496872'"/>
...
<xsl:variable name="para_nob" select="'enighet-om-nasjonal-klimadugnad.html_id=496872'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'-Nationala-dalkkadatlotnolasbarggu-soahp.html_id=496872'"/>
