...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod.html_id=421'"/>
...
<xsl:variable name="para_nno" select="'hod.html_id=421'"/>
<xsl:variable name="para_nob" select="'hod.html_id=421'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'hod.html_id=421'"/>
