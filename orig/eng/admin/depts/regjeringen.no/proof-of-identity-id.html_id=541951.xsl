...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/proof-of-identity-id.html_id=541951'"/>
...
<xsl:variable name="para_nno" select="'legitimasjon.html_id=541951'"/>
<xsl:variable name="para_nob" select="'legitimasjon.html_id=541951'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'legitimauvdna.html_id=541951'"/>
