...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/Laws/Acts/the-child-welfare-act.html_id=448398'"/>
...
<xsl:variable name="para_nob" select="'barnevernloven.html_id=448398'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'barnevernloven-pa-samisk.html_id=448398'"/>
