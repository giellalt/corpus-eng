...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Press-Centre/Press-releases.html_id=276'"/>
...
<xsl:variable name="para_nno" select="'pressemeldingar.html_id=276'"/>
<xsl:variable name="para_nob" select="'pressemeldinger.html_id=276'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassadieahusat.html_id=276'"/>
