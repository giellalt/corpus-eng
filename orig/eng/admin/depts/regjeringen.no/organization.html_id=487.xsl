...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization.html_id=487'"/>
...
<xsl:variable name="para_nno" select="'organisasjon.html_id=487'"/>
<xsl:variable name="para_nob" select="'org.html_id=487'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdna.html_id=487'"/>
