...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/information-secretariat.html_id=87086'"/>
...
<xsl:variable name="para_nno" select="'informasjonssekretariatet.html_id=87086'"/>
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html_id=87086'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinallingoddi-.html_id=87086'"/>
