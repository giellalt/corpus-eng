...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/avdeling_for_presse_kultur_og_informasjo/section-for-diplomatic-relations.html_id=87020'"/>
...
<xsl:variable name="para_nob" select="'diplomatseksjonen.html_id=87020'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diplomahtasekuvdna.html_id=87020'"/>
