...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/right-to-vote-and-electoral-register.html_id=457100'"/>
...
<xsl:variable name="para_nno" select="'du-ma-ha-roysterett-og-sta-i-manntalet.html_id=457100'"/>
<xsl:variable name="para_nob" select="'du-ma-ha-stemmerett-og-sta-i-manntallet.html_id=457100'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'jienastanvuoigatvuohta-ja-jienastuslohku.html_id=457100'"/>
