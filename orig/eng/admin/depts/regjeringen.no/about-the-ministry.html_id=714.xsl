...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry.html_id=714'"/>
...
<xsl:variable name="para_nno" select="'om-departementet.html_id=714'"/>
<xsl:variable name="para_nob" select="'dep.html_id=714'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantta-birra.html_id=714'"/>
