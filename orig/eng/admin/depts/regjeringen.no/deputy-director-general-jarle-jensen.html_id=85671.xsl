...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/deputy-director-general-jarle-jensen.html_id=85671'"/>
...
<xsl:variable name="para_nob" select="'jarle_jensen.html_id=85671'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-jarle-jensen.html_id=85671'"/>
