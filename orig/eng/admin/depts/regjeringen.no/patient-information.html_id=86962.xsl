...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects/patient-information.html_id=86962'"/>
...
<xsl:variable name="para_nob" select="'pasientinformasjon.html_id=86962'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'divohasdiehtojuohkin.html_id=86962'"/>
