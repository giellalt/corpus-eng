...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/minister_foreign.html_id=1346'"/>
...
<xsl:variable name="para_nno" select="'utenriksminister-jonas-gahr-store.html_id=1346'"/>
<xsl:variable name="para_nob" select="'utenriksminister_jonas_gahr_store.html_id=1346'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'olgoriikaministtar-jonas-gahr-store.html_id=1346'"/>
