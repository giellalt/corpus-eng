...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Administrative-staff.html_id=527'"/>
...
<xsl:variable name="para_nno" select="'administrativ-leiing.html_id=527'"/>
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=527'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-jodihangoddi.html_id=527'"/>
