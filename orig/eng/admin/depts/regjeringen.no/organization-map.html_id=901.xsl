...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Organization-Map.html_id=901'"/>
...
<xsl:variable name="para_nno" select="'organisasjonskart.html_id=901'"/>
<xsl:variable name="para_nob" select="'organisasjonskart.html_id=901'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisasjonskart.html_id=901'"/>
