...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Press-Centre/Press-releases/2010/Very-good-results-in-combating-illegal-fishing.html_id=601898'"/>
...
<xsl:variable name="para_nob" select="'svart-gode-resultater-i-kampen-mot-ulovlig-fiske.html_id=601898'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'hui-buorit-bohtosat-lobihis-guolasteami-vuostalastimis.html_id=601898'"/>
