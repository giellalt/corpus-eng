...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-administration.html_id=954'"/>
...
<xsl:variable name="para_nno" select="'administrasjons--og-utviklingsavdelinga.html_id=954'"/>
<xsl:variable name="para_nob" select="'aua.html_id=954'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahus--ja-bueahttaossodat-.html_id=954'"/>
