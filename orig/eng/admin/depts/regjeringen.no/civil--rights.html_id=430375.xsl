...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/civil--rights.html_id=430375'"/>
...
<xsl:variable name="para_nob" select="'folkerett.html_id=430375'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'folkerett_samisk.html_id=430375'"/>
