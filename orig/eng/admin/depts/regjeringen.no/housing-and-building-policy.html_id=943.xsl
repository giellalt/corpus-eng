...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/Housing-and-building-policy.html_id=943'"/>
...
<xsl:variable name="para_nob" select="'bolig-_og_bygningspolitikk.html_id=943'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'assan--ja-huksenpolitihkka.html_id=943'"/>
