...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/documents/Inaugural-Address.html_id=256201'"/>
...
<xsl:variable name="para_nno" select="'tiltredingserklaringa-for-regjeringa.html_id=256201'"/>
<xsl:variable name="para_nob" select="'regjeringens-tiltredelseserklaring.html_id=256201'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehusa-alginjulggatus.html_id=256201'"/>
