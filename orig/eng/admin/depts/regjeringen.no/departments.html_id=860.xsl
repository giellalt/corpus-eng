...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments.html_id=860'"/>
...
<xsl:variable name="para_nno" select="'avdelingar.html_id=860'"/>
<xsl:variable name="para_nob" select="'avdelinger.html_id=860'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ossodagat.html_id=860'"/>
