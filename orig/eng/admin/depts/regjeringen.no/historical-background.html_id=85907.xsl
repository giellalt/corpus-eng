...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Historical-background.html_id=85907'"/>
...
<xsl:variable name="para_nob" select="'historie.html_id=85907'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'historja.html_id=85907'"/>
