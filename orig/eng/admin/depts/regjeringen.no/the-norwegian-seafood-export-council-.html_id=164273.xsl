...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/The-Norwegian-Seafood-Export-Council-.html_id=164273'"/>
...
<xsl:variable name="para_nno" select="'eksportutvalet-for-fisk-.html_id=164273'"/>
<xsl:variable name="para_nob" select="'eksportutvalget-for-fisk.html_id=164273'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guoli-olggosfievrredanlavdegottis-.html_id=164273'"/>
