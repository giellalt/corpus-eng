...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/documents-and-publications/Circulars.html_id=2011'"/>
...
<xsl:variable name="para_nno" select="'rundskriv.html_id=2011'"/>
<xsl:variable name="para_nob" select="'rundskriv.html_id=2011'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtocalus.html_id=2011'"/>
