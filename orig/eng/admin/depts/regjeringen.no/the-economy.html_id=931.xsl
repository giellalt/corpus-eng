...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/The-economy.html_id=931'"/>
...
<xsl:variable name="para_nno" select="'okonomi.html_id=931'"/>
<xsl:variable name="para_nob" select="'okonomi.html_id=931'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomiija.html_id=931'"/>
