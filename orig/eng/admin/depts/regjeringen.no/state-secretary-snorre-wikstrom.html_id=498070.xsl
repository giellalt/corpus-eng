...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff/state-secretary-snorre-wikstrom.html_id=498070'"/>
...
<xsl:variable name="para_nob" select="'statssekretar-snorre-wikstrom.html_id=498070'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-snorre-wikstrom.html_id=498070'"/>
