...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/Department-of-research-and-innovation---.html_id=1584'"/>
...
<xsl:variable name="para_nno" select="'forskings-og-innovasjonsavdelinga.html_id=1584'"/>
<xsl:variable name="para_nob" select="'forsknings-_og_innovasjonsavdelingen.html_id=1584'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'forsknings--og-innovasjonsavdelingen.html_id=1584'"/>
