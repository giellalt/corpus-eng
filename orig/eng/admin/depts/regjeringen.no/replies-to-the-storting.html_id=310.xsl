...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Whats-new/Replies-to-the-Storting.html_id=310'"/>
...
<xsl:variable name="para_nno" select="'svar-til-stortinget.html_id=310'"/>
<xsl:variable name="para_nob" select="'svar_stortinget.html_id=310'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vastadusat-stuorradiggai.html_id=310'"/>
