...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/the-department-of-administrative-affairs.html_id=1541'"/>
...
<xsl:variable name="para_nno" select="'administrasjonsavdelinga.html_id=1541'"/>
<xsl:variable name="para_nob" select="'administrasjonsavdelingen.html_id=1541'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halldahusodat.html_id=1541'"/>
