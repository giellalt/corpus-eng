...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/About-the-Ministry/Contact-information.html_id=429'"/>
...
<xsl:variable name="para_nno" select="'kontakt.html_id=429'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=429'"/>
