...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/documents/The-Report-on-the-State-of-the-Realm.html_id=87168'"/>
...
<xsl:variable name="para_nno" select="'melding-om-tilstanden-til-riket.html_id=87168'"/>
<xsl:variable name="para_nob" select="'melding-om-rikets-tilstand.html_id=87168'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dieahus-riikka-dilis.html_id=87168'"/>
