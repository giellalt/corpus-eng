...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/the-norwegian-polar-institute.html_id=85703'"/>
...
<xsl:variable name="para_nob" select="'norsk_polarinstitutt.html_id=85703'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'norgga-polarinstituhtta.html_id=85703'"/>
