...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Related-Institutions/Central-Bank-of-Norway.html_id=213276'"/>
...
<xsl:variable name="para_nno" select="'noregs-bank.html_id=213276'"/>
<xsl:variable name="para_nob" select="'norges-bank.html_id=213276'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'norga-baku.html_id=213276'"/>
