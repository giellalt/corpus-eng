...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/the-fishery-and-aquaculture-industry-res.html_id=168263'"/>
...
<xsl:variable name="para_nno" select="'forskingsfondet-til-fiskeri--og-havbruksnaringa-.html_id=168263'"/>
<xsl:variable name="para_nob" select="'fhf.html_id=168263'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fhf.html_id=168263'"/>
