...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Food-fisheries-and-agriculture/agriculture.html_id=85943'"/>
...
<xsl:variable name="para_nno" select="'landbruk.html_id=85943'"/>
<xsl:variable name="para_nob" select="'landbruk.html_id=85943'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoallu.html_id=85943'"/>
