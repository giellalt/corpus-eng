...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/communications-adviser-anita-sletten.html_id=445790'"/>
...
<xsl:variable name="para_nob" select="'anita-sletten.html_id=445790'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahallanraeaddi-anita-sletten.html_id=445790'"/>
