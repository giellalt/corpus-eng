...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin.html_id=216'"/>
...
<xsl:variable name="para_nno" select="'fin.html_id=216'"/>
<xsl:variable name="para_nob" select="'fin.html_id=216'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fin.html_id=216'"/>
