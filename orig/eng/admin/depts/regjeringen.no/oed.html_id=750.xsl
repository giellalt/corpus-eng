...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed.html_id=750'"/>
...
<xsl:variable name="para_nno" select="'oed.html_id=750'"/>
<xsl:variable name="para_nob" select="'oed.html_id=750'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oed.html_id=750'"/>
