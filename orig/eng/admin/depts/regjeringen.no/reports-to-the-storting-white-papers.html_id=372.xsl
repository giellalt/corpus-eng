...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Documents/Government-propositions-and-reports-/Reports-to-the-Storting-white-papers.html_id=372'"/>
...
<xsl:variable name="para_nno" select="'stortingsmeldingar.html_id=372'"/>
<xsl:variable name="para_nob" select="'stmeld.html_id=372'"/>
