...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning.html_id=1214'"/>
...
<xsl:variable name="para_nob" select="'regional_planlegging.html_id=1214'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'regiunala-planema-lavdegoddi-.html_id=1214'"/>
