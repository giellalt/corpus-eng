...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/disabled-people.html_id=987'"/>
...
<xsl:variable name="para_nno" select="'funksjonshemma.html_id=987'"/>
<xsl:variable name="para_nob" select="'nedsatt_funksjonsevne.html_id=987'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuoliduvvon-doaibmannavccat.html_id=987'"/>
