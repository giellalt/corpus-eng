...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/minister-of-trade-and-industry-trond-gis.html_id=582212'"/>
...
<xsl:variable name="para_nno" select="'narings--og-handelsminister-trond-giske.html_id=582212'"/>
<xsl:variable name="para_nob" select="'narings--og-handelsminister-trond-giske.html_id=582212'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ealahus--ja-gavpeministtar-trond-giske.html_id=582212'"/>
