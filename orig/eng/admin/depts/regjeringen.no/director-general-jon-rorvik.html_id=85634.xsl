...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-organisational-and-econom/director-general-jon-rorvik.html_id=85634'"/>
...
<xsl:variable name="para_nob" select="'jon_rorvik.html_id=85634'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-jon-rorvik.html_id=85634'"/>
