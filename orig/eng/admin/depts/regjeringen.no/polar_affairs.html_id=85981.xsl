...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/polar_affairs.html_id=85981'"/>
...
<xsl:variable name="para_nob" select="'nord_ressurser.html_id=85981'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'davviguovlluid-resurssaid-ja-ruoa-ossodat.html_id=85981'"/>
