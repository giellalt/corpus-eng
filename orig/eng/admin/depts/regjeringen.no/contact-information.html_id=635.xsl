...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/the-ministry-of-agriculture-and-food/Contact-information.html_id=635'"/>
...
<xsl:variable name="para_nno" select="'kontakt.html_id=635'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=635'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oktavuohta.html_id=635'"/>
