...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Subordinate-agencies-and-institutions/the-national-institute-of-nutrition-and-.html_id=163068'"/>
...
<xsl:variable name="para_nno" select="'nasjonalt-institutt-for-ernarings--og-sj.html_id=163068'"/>
<xsl:variable name="para_nob" select="'nifes.html_id=163068'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nifes.html_id=163068'"/>
