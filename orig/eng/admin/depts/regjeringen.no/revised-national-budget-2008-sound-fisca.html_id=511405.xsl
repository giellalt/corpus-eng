...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/Press-releases/2008/revised-national-budget-2008-sound-fisca.html_id=511405'"/>
...
<xsl:variable name="para_nob" select="'hoykonjunkturen-fortsetter-i-norsk-okono.html_id=511405'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'allakonjuktuvra-joatka-norgga-ekonomiija.html_id=511405'"/>
