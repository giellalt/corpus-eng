...
<xsl:variable name="filename" select="'http://regjeringen.no/en/search.html_id=86008'"/>
...
<xsl:variable name="para_nno" select="'sok.html_id=86008'"/>
<xsl:variable name="para_nob" select="'sok.html_id=86008'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ohcan.html_id=86008'"/>
