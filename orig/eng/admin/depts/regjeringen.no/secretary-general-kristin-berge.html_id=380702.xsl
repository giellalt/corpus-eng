...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/administrativ_ledelse/secretary-general-kristin-berge.html_id=380702'"/>
...
<xsl:variable name="para_nno" select="'departementsrad-kristin-berge.html_id=380702'"/>
<xsl:variable name="para_nob" select="'departementsrad-kristin-berge.html_id=380702'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantarai-helge-m-sonneland.html_id=380702'"/>
