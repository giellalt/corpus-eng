...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/press-centre/Press-releases/2010-2/Norway-ready-to-start-negotiations-with-Russia.html_id=601877'"/>
...
<xsl:variable name="para_nob" select="'presidentbesoket-norge-klar-til-a-starte-handelsavtaleforhandlinger-med-russland.html_id=601877'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'presideantagalledeapmi-norga-lea-valmma-siehtadallagoahtit-gavpesoahpamua-ruoain.html_id=601877'"/>
