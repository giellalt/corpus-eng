...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/press-centre/press-releases/2008/a-positive-attitude-towards-labour-migra.html_id=508327'"/>
...
<xsl:variable name="para_nob" select="'positiv-holdning-til-arbeidsinnvandring.html_id=508327'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'positiiva-oaidnu-bargosisfarremii.html_id=508327'"/>
