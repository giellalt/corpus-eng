...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd.html_id=380'"/>
...
<xsl:variable name="para_nno" select="'fd.html_id=380'"/>
<xsl:variable name="para_nob" select="'fd.html_id=380'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fd.html_id=380'"/>
