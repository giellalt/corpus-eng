...
<xsl:variable name="filename" select="'http://regjeringen.no/en/the-government.html_id=443314'"/>
...
<xsl:variable name="para_nno" select="'om-regjeringa.html_id=443314'"/>
<xsl:variable name="para_nob" select="'om_regjeringen.html_id=443314'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-birra.html_id=443314'"/>
