...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Immigration-and-social-inclusion.html_id=918'"/>
...
<xsl:variable name="para_nno" select="'innvandring-og-inkludering.html_id=918'"/>
<xsl:variable name="para_nob" select="'innvandring_og_inkludering.html_id=918'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sisafarren-ja-searvadahttin.html_id=918'"/>
