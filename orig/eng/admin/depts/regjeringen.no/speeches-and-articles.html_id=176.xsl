...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/whats-new/speeches-and-articles.html_id=176'"/>
...
<xsl:variable name="para_nno" select="'taler-og-artiklar.html_id=176'"/>
<xsl:variable name="para_nob" select="'taler_artikler.html_id=176'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sartnit-ja-artihkkalat.html_id=176'"/>
