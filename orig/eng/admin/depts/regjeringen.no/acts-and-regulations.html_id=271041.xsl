...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/documents-and-publications/acts-and-regulations.html_id=271041'"/>
...
<xsl:variable name="para_nno" select="'lover-og-reglar.html_id=271041'"/>
<xsl:variable name="para_nob" select="'lover_regler.html_id=271041'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-ja-lahkaasahusat.html_id=271041'"/>
