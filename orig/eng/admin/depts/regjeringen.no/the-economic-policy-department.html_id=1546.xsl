...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/The-Economic-Policy-Department.html_id=1546'"/>
...
<xsl:variable name="para_nno" select="'okonomiavdelinga.html_id=1546'"/>
<xsl:variable name="para_nob" select="'okonomiavdelingen.html_id=1546'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomiijaossodat-.html_id=1546'"/>
