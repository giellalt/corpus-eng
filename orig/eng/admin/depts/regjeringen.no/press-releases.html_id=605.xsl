...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/press-contacts/Press-releases.html_id=605'"/>
...
<xsl:variable name="para_nno" select="'pressemeldingar.html_id=605'"/>
<xsl:variable name="para_nob" select="'pressemeldinger.html_id=605'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'pressemeldinger.html_id=605'"/>
