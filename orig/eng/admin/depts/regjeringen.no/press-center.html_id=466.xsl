...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/press-center.html_id=466'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=466'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=466'"/>
