...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation.html_id=528'"/>
...
<xsl:variable name="para_nno" select="'organisasjon.html_id=528'"/>
<xsl:variable name="para_nob" select="'org.html_id=528'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdna.html_id=528'"/>
