...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre/press-releases.html_id=358'"/>
...
<xsl:variable name="para_nno" select="'pressemeldingar.html_id=358'"/>
<xsl:variable name="para_nob" select="'pressemeldinger.html_id=358'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'pressemeldinger.html_id=358'"/>
