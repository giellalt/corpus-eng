...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases/2009/goliat--an-important-part-of-the-develop.html_id=560593'"/>
...
<xsl:variable name="para_nob" select="'goliat--en-ny-byggestein-i-nord.html_id=560593'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'goliat--oa-huksengeagi-davvin.html_id=560593'"/>
