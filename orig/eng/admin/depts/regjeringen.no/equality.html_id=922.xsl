...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Equality.html_id=922'"/>
...
<xsl:variable name="para_nno" select="'likestilling.html_id=922'"/>
<xsl:variable name="para_nob" select="'likestilling.html_id=922'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dassearvu.html_id=922'"/>
