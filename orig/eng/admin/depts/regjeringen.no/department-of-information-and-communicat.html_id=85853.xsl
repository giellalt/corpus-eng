...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-information-and-communicat.html_id=85853'"/>
...
<xsl:variable name="para_nno" select="'kommunikasjonseinga.html_id=85853'"/>
<xsl:variable name="para_nob" select="'infomasjonsenheten.html_id=85853'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahallanovttadat.html_id=85853'"/>
