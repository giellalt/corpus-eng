...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/russia_eurasia.html_id=85987'"/>
...
<xsl:variable name="para_nob" select="'russland_eurasia.html_id=85987'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'miehtamailbmasa-sihkkarvuoagaaldagaid-ja-sus-riikkaid-sekuvdna.html_id=85987'"/>
