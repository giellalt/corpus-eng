...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/department-of-ict-policy-and-public-sect.html_id=1589'"/>
...
<xsl:variable name="para_nob" select="'it-politisk_avdeling.html_id=1589'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'it-politihkala-ossodat.html_id=1589'"/>
