...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/tema.html_id=259'"/>
...
<xsl:variable name="para_nno" select="'tema.html_id=259'"/>
<xsl:variable name="para_nob" select="'tema.html_id=259'"/>
