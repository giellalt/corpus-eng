...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/minister-of-local-government-and-regiona.html_id=582254'"/>
...
<xsl:variable name="para_nno" select="'kommunal--og-regionalminister-liv-signe-.html_id=582254'"/>
<xsl:variable name="para_nob" select="'kommunal--og-regionalminister-liv-signe-.html_id=582254'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gielda--ja-guovloministtar-liv-signe-nav.html_id=582254'"/>
