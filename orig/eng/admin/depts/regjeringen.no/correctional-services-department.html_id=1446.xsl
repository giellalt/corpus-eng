...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/Correctional-Services-Department.html_id=1446'"/>
...
<xsl:variable name="para_nno" select="'kriminalomsorgsavdelinga.html_id=1446'"/>
<xsl:variable name="para_nob" select="'kriminalomsorgsavdelingen.html_id=1446'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kriminalabearraigeahu-ossodat-.html_id=1446'"/>
