...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry.html_id=385'"/>
...
<xsl:variable name="para_nno" select="'om-departementet.html_id=385'"/>
<xsl:variable name="para_nob" select="'dep.html_id=385'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeanta-birra.html_id=385'"/>
