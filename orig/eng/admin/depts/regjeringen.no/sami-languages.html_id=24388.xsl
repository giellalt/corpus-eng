...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/sami-languages.html_id=24388'"/>
...
<xsl:variable name="para_nob" select="'samisk_sprak.html_id=24388'"/>
