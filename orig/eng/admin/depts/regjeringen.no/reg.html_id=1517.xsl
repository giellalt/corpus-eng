...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/reg.html_id=1517'"/>
...
<xsl:variable name="para_nob" select="'regavdelingen.html_id=1517'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'regionala-gaaldagaid-ja-ovdaneami-ossodat.html_id=1517'"/>
