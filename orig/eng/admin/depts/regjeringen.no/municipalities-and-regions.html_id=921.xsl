...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Municipalities-and-regions.html_id=921'"/>
...
<xsl:variable name="para_nno" select="'kommunar-og-distrikt.html_id=921'"/>
<xsl:variable name="para_nob" select="'kommuner_og_distrikt.html_id=921'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gielddat-ja-guovllut.html_id=921'"/>
