...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/environmental-assessment-community-devel.html_id=85672'"/>
...
<xsl:variable name="para_nob" select="'miljo-og-samfunnsutvikling.html_id=85672'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'birasielggadansekuvdna.html_id=85672'"/>
