...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-finance.html_id=973'"/>
...
<xsl:variable name="para_nno" select="'budsjett--og-okonomiavdelinga.html_id=973'"/>
<xsl:variable name="para_nob" select="'boa.html_id=973'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bueahtta--ja-ekonomiijaossodat--.html_id=973'"/>
