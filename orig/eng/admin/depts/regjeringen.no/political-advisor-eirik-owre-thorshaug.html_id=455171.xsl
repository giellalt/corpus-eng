...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Other-political-staff/political-advisor-eirik-owre-thorshaug.html_id=455171'"/>
...
<xsl:variable name="para_nno" select="'politisk-radgjevar-eirik-owre-thorshaug.html_id=455171'"/>
<xsl:variable name="para_nob" select="'eirik-owre-thorshaug.html_id=455171'"/>
