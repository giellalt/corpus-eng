...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Senior-administrative-staff/secretary-general-harald-rensvik.html_id=85697'"/>
...
<xsl:variable name="para_nob" select="'departementsrad_harald_rensvik.html_id=85697'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantarai-harald-rensvik.html_id=85697'"/>
