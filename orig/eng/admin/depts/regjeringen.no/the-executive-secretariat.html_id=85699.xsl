...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-executive-secretariat.html_id=85699'"/>
...
<xsl:variable name="para_nno" select="'sekretariat-for-leiinga.html_id=85699'"/>
<xsl:variable name="para_nob" select="'ledelsens_sekretariat.html_id=85699'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'njunnoiid-allingoddi.html_id=85699'"/>
