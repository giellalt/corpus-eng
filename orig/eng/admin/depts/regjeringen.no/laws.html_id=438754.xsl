...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/Laws.html_id=438754'"/>
...
<xsl:variable name="para_nno" select="'laws.html_id=438754'"/>
<xsl:variable name="para_nob" select="'lover_regler.html_id=438754'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-ja-njuolggadusat-.html_id=438754'"/>
