...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/consumers.html_id=214'"/>
...
<xsl:variable name="para_nno" select="'forbrukar.html_id=214'"/>
<xsl:variable name="para_nob" select="'forbruker.html_id=214'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'geavaheaddji.html_id=214'"/>
