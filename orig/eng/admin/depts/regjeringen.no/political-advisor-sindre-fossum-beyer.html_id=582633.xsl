...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff/political-advisor-sindre-fossum-beyer.html_id=582633'"/>
...
<xsl:variable name="para_nno" select="'politisk-radgjevar-sindre-fossum-beyer.html_id=582633'"/>
<xsl:variable name="para_nob" select="'politisk-radgiver-xxx.html_id=582633'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-sindre-fossum-beyer.html_id=582633'"/>
