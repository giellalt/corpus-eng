...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/development-of-companies-and-business-en/established-companies.html_id=530953'"/>
...
<xsl:variable name="para_nno" select="'etablerte-bedrifter.html_id=530953'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'asahuvvon-fitnodagat.html_id=530953'"/>
