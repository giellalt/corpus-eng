...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/norwegian-official-reports.html_id=1767'"/>
...
<xsl:variable name="para_nno" select="'nou-ar.html_id=1767'"/>
<xsl:variable name="para_nob" select="'nouer.html_id=1767'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'na-at.html_id=1767'"/>
