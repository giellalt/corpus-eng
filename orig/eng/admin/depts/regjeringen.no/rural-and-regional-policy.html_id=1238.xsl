...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy.html_id=1238'"/>
...
<xsl:variable name="para_nob" select="'regional-_og_distriktspolitikk.html_id=1238'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guovllu--ja-regionalapolitihkka.html_id=1238'"/>
