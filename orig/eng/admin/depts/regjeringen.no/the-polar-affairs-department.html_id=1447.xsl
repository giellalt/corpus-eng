...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/The-Polar-Affairs-Department.html_id=1447'"/>
...
<xsl:variable name="para_nno" select="'polaravdelinga.html_id=1447'"/>
<xsl:variable name="para_nob" select="'polaravdelingen.html_id=1447'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'polarossodat.html_id=1447'"/>
