...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Senior-administrative-staff.html_id=239'"/>
...
<xsl:variable name="para_nno" select="'administrative-leiing.html_id=239'"/>
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=239'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-jodihangoddi.html_id=239'"/>
