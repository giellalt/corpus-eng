...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/documents-and-publications/acts-and-regulations/acts.html_id=704'"/>
...
<xsl:variable name="para_nno" select="'lover.html_id=704'"/>
<xsl:variable name="para_nob" select="'lover.html_id=704'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat.html_id=704'"/>
