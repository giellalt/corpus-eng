...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/polling-cards.html_id=541954'"/>
...
<xsl:variable name="para_nno" select="'valkort.html_id=541954'"/>
<xsl:variable name="para_nob" select="'valgkort.html_id=541954'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'valgakoarta.html_id=541954'"/>
