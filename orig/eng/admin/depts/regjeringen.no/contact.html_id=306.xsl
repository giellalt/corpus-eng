...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/contact.html_id=306'"/>
...
<xsl:variable name="para_nno" select="'kontakt-bld.html_id=306'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=306'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oktavuohtadiehtojuohkin.html_id=306'"/>
