...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-working-environment-and-safety-depar/Director-General-Gundla-Kvam.html_id=1443'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef.html_id=1443'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'-Ekspediuvdnahoavda--Gundla-Kvam.html_id=1443'"/>
