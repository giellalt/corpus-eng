...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Documents/Legislation.html_id=313564'"/>
...
<xsl:variable name="para_nno" select="'lover-og-reglar.html_id=313564'"/>
<xsl:variable name="para_nob" select="'lover_regler.html_id=313564'"/>
