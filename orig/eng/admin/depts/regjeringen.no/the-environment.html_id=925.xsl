...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/The-environment.html_id=925'"/>
...
<xsl:variable name="para_nno" select="'miljo.html_id=925'"/>
<xsl:variable name="para_nob" select="'miljo.html_id=925'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'biras.html_id=925'"/>
