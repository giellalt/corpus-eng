...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/The-Administrative-Affairs-Department.html_id=1451'"/>
...
<xsl:variable name="para_nno" select="'plan--og-administrasjonsshyavdelinga.html_id=1451'"/>
<xsl:variable name="para_nob" select="'plan-_og_administrasjonsavdelingen.html_id=1451'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'plana--ja-halddahusossodat.html_id=1451'"/>
