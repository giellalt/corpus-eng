...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/The-National-Veterinary-Institute.html_id=168615'"/>
...
<xsl:variable name="para_nno" select="'veterinarinstituttet.html_id=168615'"/>
<xsl:variable name="para_nob" select="'veterinarinstituttet.html_id=168615'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'veterinearainstituhtta.html_id=168615'"/>
