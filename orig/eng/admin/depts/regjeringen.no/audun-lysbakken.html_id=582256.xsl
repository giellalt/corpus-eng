...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/audun-lysbakken.html_id=582256'"/>
...
<xsl:variable name="para_nno" select="'barne--likestillings--og-inkluderingsmin.html_id=582256'"/>
<xsl:variable name="para_nob" select="'barne--og-likestillingsminister-audun-ly.html_id=582256'"/>
