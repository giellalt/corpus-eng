...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Child-welfare/call-child-welfare.html_id=537079'"/>
...
<xsl:variable name="para_nob" select="'melde-til-barnevernet.html_id=537079'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dieihit-manaidsuodjalussii.html_id=537079'"/>
