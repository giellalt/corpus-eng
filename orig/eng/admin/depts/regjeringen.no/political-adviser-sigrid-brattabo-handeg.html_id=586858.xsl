...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/other-political-staff/political-adviser-sigrid-brattabo-handeg.html_id=586858'"/>
...
<xsl:variable name="para_nno" select="'politisk-radgijevar-sigrid-brattabo-hand.html_id=586858'"/>
<xsl:variable name="para_nob" select="'politisk-radgiver-sigrid-brattabo-handeg.html_id=586858'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-sigrid-brattabo-hand.html_id=586858'"/>
