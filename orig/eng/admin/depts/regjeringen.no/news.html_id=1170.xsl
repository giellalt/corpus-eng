...
<xsl:variable name="filename" select="'http://regjeringen.no/en/whatsnew/news.html_id=1170'"/>
...
<xsl:variable name="para_nno" select="'nyheiter.html_id=1170'"/>
<xsl:variable name="para_nob" select="'nyheter.html_id=1170'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oddasat.html_id=1170'"/>
