...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-international-cooperation/Director-General-Hage-Andenas.html_id=85663'"/>
...
<xsl:variable name="para_nob" select="'hage_andenas.html_id=85663'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-hage-andenas.html_id=85663'"/>
