...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/dok/lover_regler/lover.html_id=540'"/>
...
<xsl:variable name="para_nno" select="'lover-og-reglar.html_id=272526'"/>
<xsl:variable name="para_nob" select="'lover_regler.html_id=272526'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-ja-njuolggadusat.html_id=272526'"/>
