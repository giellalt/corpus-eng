...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/The-Ministey/minister-of-petroleum-and-energy-terje-r.html_id=518472'"/>
...
<xsl:variable name="para_nno" select="'olje--og-energiminister-terje-riis-johan.html_id=518472'"/>
<xsl:variable name="para_nob" select="'olje--og-energiminister-terje-riis-johan.html_id=518472'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'tjr.html_id=518472'"/>
