...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/disarmament.html_id=85988'"/>
...
<xsl:variable name="para_nob" select="'seksjon_for_nedrustning_og_ikke-sprednin.html_id=85988'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vearjjuid-geahpedeami-ja-vearjjuid-viidananeastadeami-sekuvdna.html_id=85988'"/>
