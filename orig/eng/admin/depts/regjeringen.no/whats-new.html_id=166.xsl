...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/whats-new.html_id=166'"/>
...
<xsl:variable name="para_nno" select="'aktuelt.html_id=166'"/>
<xsl:variable name="para_nob" select="'aktuelt.html_id=166'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'aigeguovdil.html_id=166'"/>
