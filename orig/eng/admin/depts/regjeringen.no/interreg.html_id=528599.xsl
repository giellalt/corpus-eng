...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/international-cooperation-on-rural-and-r/interreg.html_id=528599'"/>
...
<xsl:variable name="para_nob" select="'interreg-2.html_id=528599'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oassalastin-eu-territoriala-ovttasbarggu.html_id=528599'"/>
