...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2010/More-housing-support-for-families-with-children--.html_id=619669'"/>
...
<xsl:variable name="para_sme" select="'eanet-orrundoarjja-bearraiidda-geain-leat-manat--.html_id=619669'"/>
