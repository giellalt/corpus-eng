...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry.html_id=221'"/>
...
<xsl:variable name="para_nno" select="'om-departementet.html_id=221'"/>
<xsl:variable name="para_nob" select="'dep.html_id=221'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantta-birra.html_id=221'"/>
