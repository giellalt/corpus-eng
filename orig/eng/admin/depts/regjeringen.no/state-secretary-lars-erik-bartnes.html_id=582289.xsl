...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/other-political-staff/state-secretary-lars-erik-bartnes.html_id=582289'"/>
...
<xsl:variable name="para_nno" select="'statssekretar-lars-erik-bartnes.html_id=582289'"/>
<xsl:variable name="para_nob" select="'statssekretar-lars-erik-bartnes.html_id=582289'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'-stahtaalli-lars-erik-bartnes.html_id=582289'"/>
