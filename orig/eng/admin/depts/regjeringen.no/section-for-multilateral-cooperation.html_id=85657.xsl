...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-international-cooperation/section-for-multilateral-cooperation.html_id=85657'"/>
...
<xsl:variable name="para_nob" select="'multilateralt_samarbeid_miljofora.html_id=85657'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'globala-ovttasbarggu-sekuvdna-.html_id=85657'"/>
