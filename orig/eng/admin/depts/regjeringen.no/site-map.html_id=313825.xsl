...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/Site-Map.html_id=313825'"/>
...
<xsl:variable name="para_nno" select="'313825.html_id=313825'"/>
<xsl:variable name="para_nob" select="'nettstedskart.html_id=313825'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'neahttakarta-.html_id=313825'"/>
