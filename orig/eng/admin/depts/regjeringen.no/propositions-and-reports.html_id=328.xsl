...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Documents/Propositions-and-reports.html_id=328'"/>
...
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html_id=328'"/>
<xsl:variable name="para_nob" select="'regpubl.html_id=328'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'proposiuvnnat-ja-dieahusat.html_id=328'"/>
