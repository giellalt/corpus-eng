...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/Tax_Policy_Department.html_id=1547'"/>
...
<xsl:variable name="para_nno" select="'skatteokonomisk-avdeling.html_id=1547'"/>
<xsl:variable name="para_nob" select="'skatteokonomisk_avdeling.html_id=1547'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vearroekonomala-ossodat-.html_id=1547'"/>
