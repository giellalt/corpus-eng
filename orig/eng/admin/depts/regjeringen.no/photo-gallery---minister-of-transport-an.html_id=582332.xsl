...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/magnhild-meltveit-kleppa/photo-gallery---minister-of-transport-an.html_id=582332'"/>
...
<xsl:variable name="para_nno" select="'bilder-av-samferdselsminister-magnhild-m.html_id=582332'"/>
<xsl:variable name="para_nob" select="'bilder-av-samferdselsminister-magnhild-m.html_id=582332'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka---johtalusministtar-magnhild.html_id=582332'"/>
