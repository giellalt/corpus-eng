...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/International-relations/International-cooperation.html_id=1166'"/>
...
<xsl:variable name="para_nno" select="'internasjonalt-fagsamarbeid.html_id=1166'"/>
<xsl:variable name="para_nob" select="'internasjonalt_fagsamarbeid.html_id=1166'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riikkaidgaskasa-fagaovttasbargu.html_id=1166'"/>
