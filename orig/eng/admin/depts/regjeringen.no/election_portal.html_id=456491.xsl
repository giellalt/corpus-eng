...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal.html_id=456491'"/>
...
<xsl:variable name="para_nno" select="'valportalen.html_id=456491'"/>
<xsl:variable name="para_nob" select="'valg.html_id=456491'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'valga-portal.html_id=456491'"/>
