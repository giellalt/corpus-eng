...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit.html_id=1708'"/>
...
<xsl:variable name="para_nno" select="'kommunikasjonseininga.html_id=1708'"/>
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html_id=1708'"/>
