...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/ethnic-discrimination.html_id=1145'"/>
...
<xsl:variable name="para_nob" select="'rasisme_og_diskriminering.html_id=1145'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'earddala-vealaheapmi.html_id=1145'"/>
