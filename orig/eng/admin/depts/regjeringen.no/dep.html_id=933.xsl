...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep.html_id=933'"/>
...
<xsl:variable name="para_nno" select="'dep.html_id=933'"/>
<xsl:variable name="para_nob" select="'dep.html_id=933'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dep.html_id=933'"/>
