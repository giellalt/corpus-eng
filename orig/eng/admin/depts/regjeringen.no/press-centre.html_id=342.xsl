...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre.html_id=342'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=342'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=342'"/>
