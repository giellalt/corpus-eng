...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Departments/press-and-information-section/Communication-Officer-Trude-Maseide.html_id=1707'"/>
...
<xsl:variable name="para_nob" select="'trude_maseide.html_id=1707'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kommunikasjonsradgiver-trude-maseide.html_id=1707'"/>
