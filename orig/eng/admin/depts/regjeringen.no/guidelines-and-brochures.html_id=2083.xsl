...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Documents/Guidelines-and-brochures.html_id=2083'"/>
...
<xsl:variable name="para_nno" select="'rettleiingar-og-brosjyrar.html_id=2083'"/>
<xsl:variable name="para_nob" select="'veiledninger_brosjyrer.html_id=2083'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bagadusat-ja-gihppagat.html_id=2083'"/>
