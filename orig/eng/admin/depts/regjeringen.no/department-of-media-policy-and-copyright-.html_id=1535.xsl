...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/Department-of-Media-Policy-and-Copyright-.html_id=1535'"/>
...
<xsl:variable name="para_nno" select="'medieavdelinga.html_id=1535'"/>
<xsl:variable name="para_nob" select="'medieavdelingen_.html_id=1535'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mediaossodat.html_id=1535'"/>
