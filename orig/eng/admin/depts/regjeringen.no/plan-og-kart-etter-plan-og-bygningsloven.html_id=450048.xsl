...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dokumentarkiv/stoltenberg-ii/md/Veiledninger_og_brosjyrer/2006/plan-og-kart-etter-plan-og-bygningsloven.html_id=450048'"/>
...
<xsl:variable name="para_nob" select="'plan-og-kart-etter-plan-og-bygningsloven.html_id=450048'"/>
