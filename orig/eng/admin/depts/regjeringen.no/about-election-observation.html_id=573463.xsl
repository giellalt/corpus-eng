...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation/about-election-observation.html_id=573463'"/>
...
<xsl:variable name="para_nob" select="'om-valgobservasjon.html_id=573463'"/>
