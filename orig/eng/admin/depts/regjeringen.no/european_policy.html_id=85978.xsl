...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/european_policy.html_id=85978'"/>
...
<xsl:variable name="para_nob" select="'europapolitisk_seksjon.html_id=85978'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eurohpapolitihka-sekuvdna-.html_id=85978'"/>
