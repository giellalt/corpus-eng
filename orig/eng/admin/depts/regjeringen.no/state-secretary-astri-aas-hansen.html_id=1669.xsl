...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Other-political-staff/State-Secretary-Astri-Aas-Hansen.html_id=1669'"/>
...
<xsl:variable name="para_nno" select="'astri_aas_hansen.html_id=1669'"/>
<xsl:variable name="para_nob" select="'astri_aas_hansen.html_id=1669'"/>
