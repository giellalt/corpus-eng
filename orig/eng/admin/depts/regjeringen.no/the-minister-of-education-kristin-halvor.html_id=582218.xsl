...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/About-the-Ministry/the-minister-of-education-kristin-halvor.html_id=582218'"/>
...
<xsl:variable name="para_nno" select="'finansminister-kristin-halvorsen-er-fodt.html_id=582218'"/>
<xsl:variable name="para_nob" select="'kunnskapsminister-kristin-halvorsen.html_id=582218'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mahttoministtar-kristin-halvorsen.html_id=582218'"/>
