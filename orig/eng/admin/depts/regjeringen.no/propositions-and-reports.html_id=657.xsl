...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Documents/propositions-and-reports.html_id=657'"/>
...
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html_id=657'"/>
<xsl:variable name="para_nob" select="'regpubl.html_id=657'"/>
