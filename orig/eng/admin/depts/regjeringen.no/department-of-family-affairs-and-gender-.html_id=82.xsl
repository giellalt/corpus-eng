...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/department-of-family-affairs-and-gender-.html_id=82'"/>
...
<xsl:variable name="para_nno" select="'samlivs--og-likestillingsavdelinga.html_id=82'"/>
<xsl:variable name="para_nob" select="'sla.html_id=82'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovttaseallin--ja-dassearvoossodat.html_id=82'"/>
