...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Senior-administrative-staff.html_id=280'"/>
...
<xsl:variable name="para_nno" select="'administrativ-leiing.html_id=280'"/>
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=280'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-joihus.html_id=280'"/>
