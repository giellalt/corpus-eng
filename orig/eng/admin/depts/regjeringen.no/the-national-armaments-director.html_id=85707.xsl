...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-national-armaments-director.html_id=85707'"/>
...
<xsl:variable name="para_nno" select="'controllereining.html_id=85707'"/>
<xsl:variable name="para_nob" select="'controllerenhet.html_id=85707'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'controller-ovttadat.html_id=85707'"/>
