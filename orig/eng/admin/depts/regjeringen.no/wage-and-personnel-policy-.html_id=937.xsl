...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Wage-and-personnel-policy-.html_id=937'"/>
...
<xsl:variable name="para_nob" select="'lonns-_og_personalpolitikk.html_id=937'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'balka--ja-bargoveahkapolitihkka.html_id=937'"/>
