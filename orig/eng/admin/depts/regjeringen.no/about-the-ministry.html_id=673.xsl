...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry.html_id=673'"/>
...
<xsl:variable name="para_nno" select="'om-departementet.html_id=673'"/>
<xsl:variable name="para_nob" select="'dep.html_id=673'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeanta-birra.html_id=673'"/>
