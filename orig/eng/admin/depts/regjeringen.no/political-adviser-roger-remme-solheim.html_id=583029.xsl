...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/other-political-staff/political-adviser-roger-remme-solheim.html_id=583029'"/>
...
<xsl:variable name="para_nno" select="'politisk-radgivar-roger-remme-solheim.html_id=583029'"/>
<xsl:variable name="para_nob" select="'politisk-radgiver-roger-remme-solheim.html_id=583029'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-roger-remme-solheim.html_id=583029'"/>
