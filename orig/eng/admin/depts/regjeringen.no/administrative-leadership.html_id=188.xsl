...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/Administrative-leadership.html_id=188'"/>
...
<xsl:variable name="para_nno" select="'administrativ-leiing.html_id=188'"/>
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=188'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusnjunugoddi-.html_id=188'"/>
