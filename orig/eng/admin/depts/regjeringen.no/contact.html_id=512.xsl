...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/contact.html_id=512'"/>
...
<xsl:variable name="para_nno" select="'kontakt.html_id=512'"/>
<xsl:variable name="para_nob" select="'kontakt.html_id=512'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kontakt.html_id=512'"/>
