...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center.html_id=753'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=753'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=753'"/>
