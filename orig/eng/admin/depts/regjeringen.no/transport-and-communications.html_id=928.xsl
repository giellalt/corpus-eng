...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Transport-and-communications.html_id=928'"/>
...
<xsl:variable name="para_nno" select="'transport-og-kommunikasjon.html_id=928'"/>
<xsl:variable name="para_nob" select="'transport_og_kommunikasjon.html_id=928'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fievrrideapmi-ja-johtalus-.html_id=928'"/>
