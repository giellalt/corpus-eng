...
<xsl:variable name="filename" select="'http://regjeringen.no/en/whatsnew/rss.html_id=478812'"/>
...
<xsl:variable name="para_nno" select="'rss.html_id=478812'"/>
<xsl:variable name="para_nob" select="'rss.html_id=478812'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'rss.html_id=478812'"/>
