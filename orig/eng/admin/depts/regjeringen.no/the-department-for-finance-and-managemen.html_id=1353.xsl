...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-department-for-finance-and-managemen.html_id=1353'"/>
...
<xsl:variable name="para_nno" select="'avdeling-for-okonomi-og-styring.html_id=1353'"/>
<xsl:variable name="para_nob" select="'avdeling_for_okonomi_og_styring.html_id=1353'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomiija--ja-stivrenossodat.html_id=1353'"/>
