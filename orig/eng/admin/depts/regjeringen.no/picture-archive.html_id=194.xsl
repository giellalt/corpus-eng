...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/press-centre/picture-archive.html_id=194'"/>
...
<xsl:variable name="para_nno" select="'bildearkiv.html_id=194'"/>
<xsl:variable name="para_nob" select="'bildearkiv.html_id=194'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka-.html_id=194'"/>
