...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-welfare-policy.html_id=1456'"/>
...
<xsl:variable name="para_nno" select="'velferdspolitisk-avdeling.html_id=1456'"/>
<xsl:variable name="para_nob" select="'vpa.html_id=1456'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'algopolitihkala-ossodat-.html_id=1456'"/>
