...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/minister-of-culture-anniken-huitfeldt.html_id=582305'"/>
...
<xsl:variable name="para_nno" select="'kulturminister-anniken-huitfeldt.html_id=582305'"/>
<xsl:variable name="para_nob" select="'kulturminister-anniken-huitfeldt.html_id=582305'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kulturministtar-anniken-huitfeldt.html_id=582305'"/>
