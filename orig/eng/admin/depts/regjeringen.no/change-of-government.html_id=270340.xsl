...
<xsl:variable name="filename" select="'http://regjeringen.no/en/the-government/the-government-at-work/change-of-government.html_id=270340'"/>
...
<xsl:variable name="para_nno" select="'kva-skjer-ved-regjeringsskifte.html_id=270340'"/>
<xsl:variable name="para_nob" select="'hva-skjer-ved-regjeringesskifte.html_id=270340'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehusa-molsun.html_id=270340'"/>
