...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-organisational-and-econom/Section-for-Environmental-Economics-and-Analysis-.html_id=85627'"/>
...
<xsl:variable name="para_nob" select="'miljookonomi_og_analyse.html_id=85627'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'birasekonomiija-ja-analysa-sekuuvdna.html_id=85627'"/>
