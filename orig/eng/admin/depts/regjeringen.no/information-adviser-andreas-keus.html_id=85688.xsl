...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/press-and-information-unit/information-adviser-andreas-keus.html_id=85688'"/>
...
<xsl:variable name="para_nob" select="'andreas_keus.html_id=85688'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinraeaddi-anders-keus.html_id=85688'"/>
