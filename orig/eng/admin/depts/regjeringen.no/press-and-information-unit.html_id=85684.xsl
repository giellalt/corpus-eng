...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/press-and-information-unit.html_id=85684'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html_id=85684'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassa--ja-diehtojuohkinossodat.html_id=85684'"/>
