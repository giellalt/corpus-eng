...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Senior-administrative-staff.html_id=85696'"/>
...
<xsl:variable name="para_nno" select="'administrativ-leiing.html_id=85696'"/>
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=85696'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-joihus.html_id=85696'"/>
