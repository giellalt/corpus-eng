...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/policy-for-lifelong-learning.html_id=1407'"/>
...
<xsl:variable name="para_nob" select="'utdanning_og_kompetanse.html_id=1407'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gelbbolavuoapolitihkka.html_id=1407'"/>
