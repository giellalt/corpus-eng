...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/midtspalte/consultation-duty-in-sami-matters.html_id=86931'"/>
...
<xsl:variable name="para_nob" select="'konsultasjonsplikt-i-samiske-saker.html_id=86931'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'konsultauvdnageatnegasvuohta-sami-aiin.html_id=86931'"/>
