...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles.html_id=886'"/>
...
<xsl:variable name="para_nno" select="'talar-og-artiklar.html_id=886'"/>
<xsl:variable name="para_nob" select="'taler_og_artikler.html_id=886'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'taler_og_artikler.html_id=886'"/>
