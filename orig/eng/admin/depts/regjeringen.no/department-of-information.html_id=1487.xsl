...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/department-of-information.html_id=1487'"/>
...
<xsl:variable name="para_nno" select="'informasjonseininga.html_id=1487'"/>
<xsl:variable name="para_nob" select="'informasjonsenheten_.html_id=1487'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinovttadat-.html_id=1487'"/>
