...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/minister-of-labour-hanne-bjurstrom.html_id=588975'"/>
...
<xsl:variable name="para_nno" select="'arbeidsminister-hanne-bjurstrom.html_id=588975'"/>
<xsl:variable name="para_nob" select="'arbeidsminister-hanne-bjurstrom.html_id=588975'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargoministtar-hanne-bjurstrom.html_id=588975'"/>
