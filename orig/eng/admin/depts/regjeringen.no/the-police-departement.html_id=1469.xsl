...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/the-police-departement.html_id=1469'"/>
...
<xsl:variable name="para_nno" select="'politiavdelinga.html_id=1469'"/>
<xsl:variable name="para_nob" select="'politiavdelingen.html_id=1469'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politiijaossodat-.html_id=1469'"/>
