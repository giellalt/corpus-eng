...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/The-Department-of-Sport/sadjasa-ekspediuvdnahoavda-per-kristian-.html_id=551554'"/>
...
<xsl:variable name="para_nno" select="'fungerande-ekspedisjonssjef-per-kristian.html_id=551554'"/>
<xsl:variable name="para_nob" select="'ekspedisjonssjef-paul-glomsaker.html_id=551554'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-per-kristian-aasmunds.html_id=551554'"/>
