...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/Higher-Education.html_id=1415'"/>
...
<xsl:variable name="para_nob" select="'hoyere_utdanning.html_id=1415'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'alit-oahppu.html_id=1415'"/>
