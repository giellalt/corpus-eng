...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation.html_id=573442'"/>
...
<xsl:variable name="para_nob" select="'valgobservasjon.html_id=573442'"/>
