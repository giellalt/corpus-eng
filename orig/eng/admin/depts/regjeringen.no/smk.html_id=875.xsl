...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk.html_id=875'"/>
...
<xsl:variable name="para_nno" select="'smk.html_id=875'"/>
<xsl:variable name="para_nob" select="'smk.html_id=875'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'smk.html_id=875'"/>
