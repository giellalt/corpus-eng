...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/the-department-of-integration-and-divers.html_id=589415'"/>
...
<xsl:variable name="para_nno" select="'integrerings--og-mangfaldsavdelinga.html_id=589415'"/>
<xsl:variable name="para_nob" select="'integrerings--og-mangfoldsavdelingen.html_id=589415'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'searvadahttin--ja-girjaivuoaossodat-.html_id=589415'"/>
