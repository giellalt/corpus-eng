...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases.html_id=769'"/>
...
<xsl:variable name="para_nno" select="'pressemeldingar.html_id=769'"/>
<xsl:variable name="para_nob" select="'pressemeldinger.html_id=769'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'pressemeldinger.html_id=769'"/>
