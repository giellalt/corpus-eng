...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Civil-protection-and-defence/Terrorism.html_id=1114'"/>
...
<xsl:variable name="para_nno" select="'terrorisme.html_id=1114'"/>
<xsl:variable name="para_nob" select="'terrorisme.html_id=1114'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'terrorisma.html_id=1114'"/>
