...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/the-ministry-of-agriculture-and-food/minister-of-agriculture-and-food-lars-pe.html_id=518468'"/>
...
<xsl:variable name="para_nno" select="'landbruks--og-matminister-lars-peder-bre.html_id=518468'"/>
<xsl:variable name="para_nob" select="'landbruks--og-matminister-lars-peder-bre.html_id=518468'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanandoallo--ja-biebmoministtar-lars-ped.html_id=518468'"/>
