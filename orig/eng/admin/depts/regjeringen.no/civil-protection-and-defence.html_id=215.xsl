...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Civil-protection-and-defence.html_id=215'"/>
...
<xsl:variable name="para_nno" select="'samfunntryggleik-og-forsvar.html_id=215'"/>
<xsl:variable name="para_nob" select="'forsvars_og_sikkerhetspolitikk.html_id=215'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'servodat-sihkkarvuohta-ja-suodjalus.html_id=215'"/>
