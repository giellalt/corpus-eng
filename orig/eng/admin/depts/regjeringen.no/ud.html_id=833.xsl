...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud.html_id=833'"/>
...
<xsl:variable name="para_nno" select="'ud.html_id=833'"/>
<xsl:variable name="para_nob" select="'ud.html_id=833'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ud.html_id=833'"/>
