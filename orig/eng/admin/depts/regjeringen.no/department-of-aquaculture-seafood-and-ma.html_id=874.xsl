...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-aquaculture-seafood-and-ma.html_id=874'"/>
...
<xsl:variable name="para_nno" select="'avdeling-for-havbruk-sjomat-og-marknad.html_id=874'"/>
<xsl:variable name="para_nob" select="'avdeling_for_havbruk_sjomat_og_marked.html_id=874'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mearradoalu-mearrabiepmu-ja-markana-osso.html_id=874'"/>
