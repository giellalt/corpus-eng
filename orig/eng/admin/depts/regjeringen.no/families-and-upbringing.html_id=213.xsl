...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/families-and-upbringing.html_id=213'"/>
...
<xsl:variable name="para_nno" select="'familie-og-oppvekst.html_id=213'"/>
<xsl:variable name="para_nob" select="'familie_og_oppvekst.html_id=213'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'beara-ja-bajasaddan.html_id=213'"/>
