...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/documents-and-publications/acts-and-regulations/regulations.html_id=705'"/>
...
<xsl:variable name="para_nno" select="'forskrifter.html_id=705'"/>
<xsl:variable name="para_nob" select="'forskrifter.html_id=705'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lahkaasahusat.html_id=705'"/>
