...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/Department-of-Employer-Policy.html_id=1590'"/>
...
<xsl:variable name="para_nob" select="'arbeidsgiverpolitisk_avdeling.html_id=1590'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargoaddipolitihkala-ossodat.html_id=1590'"/>
