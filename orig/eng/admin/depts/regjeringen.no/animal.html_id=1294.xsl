...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Subjects/animal.html_id=1294'"/>
...
<xsl:variable name="para_nno" select="'dyr.html_id=1294'"/>
<xsl:variable name="para_nob" select="'dyr.html_id=1294'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eallit.html_id=1294'"/>
