...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/western_balkans.html_id=85980'"/>
...
<xsl:variable name="para_nob" select="'vest_balkan.html_id=85980'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oarje-balkan-sekuvdna.html_id=85980'"/>
