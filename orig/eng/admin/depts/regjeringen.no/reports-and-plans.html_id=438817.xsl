...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/Reports-and-plans.html_id=438817'"/>
...
<xsl:variable name="para_nno" select="'rapportar-og-planar.html_id=438817'"/>
<xsl:variable name="para_nob" select="'rapporter_planer.html_id=438817'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raporttat-ja-planat.html_id=438817'"/>
