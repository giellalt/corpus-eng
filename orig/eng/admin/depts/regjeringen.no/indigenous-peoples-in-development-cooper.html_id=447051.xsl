...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/human-rights/menneskerettigheter-urfolk/indigenous-peoples-in-development-cooper.html_id=447051'"/>
...
<xsl:variable name="para_nob" select="'urfolk-i-utviklingsarbeidet.html_id=447051'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'utvpol_samisk.html_id=447051'"/>
