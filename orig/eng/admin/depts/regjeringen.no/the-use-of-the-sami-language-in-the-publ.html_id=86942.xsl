...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/use-of-the-sami-languages/the-use-of-the-sami-language-in-the-publ.html_id=86942'"/>
...
<xsl:variable name="para_nob" select="'bruk-av-samisk-sprak-i-offentlig-forvalt.html_id=86942'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'samegiela-geavaheapmi-almmola-halddahusa.html_id=86942'"/>
