...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut/department-secretariat.html_id=85646'"/>
...
<xsl:variable name="para_nob" select="'avdelingssekretariatet.html_id=85646'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ossodatallingoddi.html_id=85646'"/>
