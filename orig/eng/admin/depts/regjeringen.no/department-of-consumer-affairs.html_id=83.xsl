...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/Department-of-Consumer-Affairs.html_id=83'"/>
...
<xsl:variable name="para_nno" select="'forbrukaravdelinga.html_id=83'"/>
<xsl:variable name="para_nob" select="'for.html_id=83'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'golaheaddjiossodat.html_id=83'"/>
