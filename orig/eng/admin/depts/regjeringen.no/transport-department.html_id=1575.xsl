...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/transport-department.html_id=1575'"/>
...
<xsl:variable name="para_nno" select="'transportavdelinga-ta.html_id=1575'"/>
<xsl:variable name="para_nob" select="'transportavdelingen.html_id=1575'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fievrredanossodat.html_id=1575'"/>
