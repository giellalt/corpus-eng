...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Health-and-care.html_id=917'"/>
...
<xsl:variable name="para_nno" select="'helse-og-omsorg.html_id=917'"/>
<xsl:variable name="para_nob" select="'helse.html_id=917'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dearvvavuohta-ja-fuolahus.html_id=917'"/>
