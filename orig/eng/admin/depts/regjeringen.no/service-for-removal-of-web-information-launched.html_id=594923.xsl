...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/whats-new/news/2010/Service-for-removal-of-web-information-launched.html_id=594923'"/>
...
<xsl:variable name="para_nno" select="'slettmegno-er-lansert.html_id=594923'"/>
<xsl:variable name="para_nob" select="'slettmegno-er-lansert.html_id=594923'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'slettmegno-lea-almmuhuvvon.html_id=594923'"/>
