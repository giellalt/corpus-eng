...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd.html_id=709'"/>
...
<xsl:variable name="para_nno" select="'nhd.html_id=709'"/>
<xsl:variable name="para_nob" select="'nhd.html_id=709'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nhd.html_id=709'"/>
