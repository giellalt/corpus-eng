...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation/links.html_id=573467'"/>
...
<xsl:variable name="para_nno" select="'lenker.html_id=573467'"/>
<xsl:variable name="para_nob" select="'lenker.html_id=573467'"/>
