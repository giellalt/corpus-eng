...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po.html_id=468'"/>
...
<xsl:variable name="para_nno" select="'om-departementet.html_id=468'"/>
<xsl:variable name="para_nob" select="'dep.html_id=468'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'justisdepartementta-birra.html_id=468'"/>
