...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation/relevant-documents-election-observation.html_id=573466'"/>
...
<xsl:variable name="para_nob" select="'aktuelle-dokumenter.html_id=573466'"/>
