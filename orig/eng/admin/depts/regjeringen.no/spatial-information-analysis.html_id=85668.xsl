...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/spatial-information-analysis.html_id=85668'"/>
...
<xsl:variable name="para_nob" select="'kart-analyse-planinformasjon.html_id=85668'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'geografala-diehtojuohkin-sekuvdna.html_id=85668'"/>
