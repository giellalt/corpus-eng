...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/engelsk-tema.html_id=210'"/>
...
<xsl:variable name="para_nno" select="'arbeid-og-velferd-nynorsk.html_id=210'"/>
<xsl:variable name="para_nob" select="'arbeid_og_velferd.html_id=210'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargu-ja-algu.html_id=210'"/>
