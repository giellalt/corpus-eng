...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Other-political-staff.html_id=485'"/>
...
<xsl:variable name="para_nno" select="'anna-politisk-leiing.html_id=485'"/>
<xsl:variable name="para_nob" select="'politisk_ledelse.html_id=485'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eara-politihkala-njunnoat.html_id=485'"/>
