...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Other-political-staff/Vidar-Ulriksen--Secretary-of-State/Picture-archive.html_id=438704'"/>
...
<xsl:variable name="para_nno" select="'biletarkiv.html_id=438704'"/>
<xsl:variable name="para_nob" select="'bildearkiv.html_id=438704'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka.html_id=438704'"/>
