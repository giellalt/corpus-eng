...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/press-centre.html_id=383'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=383'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=383'"/>
