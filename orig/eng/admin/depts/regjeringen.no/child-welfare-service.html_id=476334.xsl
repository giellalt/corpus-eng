...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Child-welfare/Child-welfare-service.html_id=476334'"/>
...
<xsl:variable name="para_nob" select="'barnevernets-oppgaver.html_id=476334'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'manaidsuodjalusa-doaimmat.html_id=476334'"/>
