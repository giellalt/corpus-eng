...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation.html_id=815'"/>
...
<xsl:variable name="para_nno" select="'organisasjon.html_id=815'"/>
<xsl:variable name="para_nob" select="'organisasjon.html_id=815'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdna.html_id=815'"/>
