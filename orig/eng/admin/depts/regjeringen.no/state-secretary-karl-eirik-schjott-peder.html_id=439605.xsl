...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff/state-secretary-karl-eirik-schjott-peder.html_id=439605'"/>
...
<xsl:variable name="para_nno" select="'statsrad-karl-eirik-schjott-pedersen.html_id=439605'"/>
<xsl:variable name="para_nob" select="'statssekretar-karl-eirik-schjott-pederse.html_id=439605'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-karl-eirik-schjott-pedersen.html_id=439605'"/>
