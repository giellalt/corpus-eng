...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Related-Institutions.html_id=115193'"/>
...
<xsl:variable name="para_nno" select="'tilknytta-verksemder.html_id=115193'"/>
<xsl:variable name="para_nob" select="'tilknyttede_virksomheter.html_id=115193'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'atnaseaddji-doaimmahusat.html_id=115193'"/>
