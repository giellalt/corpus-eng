...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/History-of-the-Ministry-of-Children-and-.html_id=326'"/>
...
<xsl:variable name="para_nno" select="'historia-til-barne--og-likestillingsdepa.html_id=326'"/>
<xsl:variable name="para_nob" select="'historikk.html_id=326'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'historja.html_id=326'"/>
