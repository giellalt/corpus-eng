...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd.html_id=791'"/>
...
<xsl:variable name="para_nno" select="'sd.html_id=791'"/>
<xsl:variable name="para_nob" select="'sd.html_id=791'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sd.html_id=791'"/>
