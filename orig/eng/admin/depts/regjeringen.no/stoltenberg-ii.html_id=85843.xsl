...
<xsl:variable name="filename" select="'http://regjeringen.no/en/the-government/stoltenberg-ii.html_id=85843'"/>
...
<xsl:variable name="para_nno" select="'stoltenberg-ii.html_id=85843'"/>
<xsl:variable name="para_nob" select="'stoltenberg-ii.html_id=85843'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stoltenberga-nubbi-raehus.html_id=85843'"/>
