...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Documents.html_id=313298'"/>
...
<xsl:variable name="para_nno" select="'dokument.html_id=313298'"/>
<xsl:variable name="para_nob" select="'dok.html_id=313298'"/>
