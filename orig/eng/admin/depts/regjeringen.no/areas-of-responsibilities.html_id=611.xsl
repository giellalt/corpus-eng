...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/About-the-Ministry/areas-of-responsibilities.html_id=611'"/>
...
<xsl:variable name="para_nno" select="'ansvarsomrade.html_id=611'"/>
<xsl:variable name="para_nob" select="'ansvarsomraader.html_id=611'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovddasvastadussuorggit.html_id=611'"/>
