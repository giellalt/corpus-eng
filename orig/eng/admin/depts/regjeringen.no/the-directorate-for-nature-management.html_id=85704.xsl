...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/The-Directorate-for-Nature-Management.html_id=85704'"/>
...
<xsl:variable name="para_nob" select="'direktoratet_for_naturforvaltning.html_id=85704'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'luondduhalddaan-direktorahta.html_id=85704'"/>
