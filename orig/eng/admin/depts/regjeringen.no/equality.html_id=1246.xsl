...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/equality.html_id=1246'"/>
...
<xsl:variable name="para_nob" select="'likestillingsomradet.html_id=1246'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dassearvu-sohkabeliid-gaskkas.html_id=1246'"/>
