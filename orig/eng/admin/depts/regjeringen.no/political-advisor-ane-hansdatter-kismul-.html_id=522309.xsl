...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/the-ministry-of-agriculture-and-food/other-political-staff/political-advisor-ane-hansdatter-kismul-.html_id=522309'"/>
...
<xsl:variable name="para_nob" select="'politisk-radgiver-ane-hansdatter-kismul-.html_id=522309'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-ane-hansdatter-kismu.html_id=522309'"/>
