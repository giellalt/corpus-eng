...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/communications-department.html_id=555839'"/>
...
<xsl:variable name="para_nno" select="'kommunikasjonsavdelinga.html_id=555839'"/>
<xsl:variable name="para_nob" select="'kommunikasjonsavdelingen.html_id=555839'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dieihanovttadat.html_id=555839'"/>
