...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/ict-policyenorway.html_id=1367'"/>
...
<xsl:variable name="para_nob" select="'ikt-politikk.html_id=1367'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ikt-politikka.html_id=1367'"/>
