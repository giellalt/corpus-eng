...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/Subjects.html_id=465'"/>
...
<xsl:variable name="para_nno" select="'tema.html_id=465'"/>
<xsl:variable name="para_nob" select="'tema.html_id=465'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fattat.html_id=465'"/>
