...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases/2007/The-right-of-reversion--The-Government-s.html_id=477332'"/>
...
<xsl:variable name="para_nob" select="'hjemfall-regjeringen-sikrer-offentlig-ei.html_id=477332'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'maasmahcaheapmi-raehus-sihkkarasta-almmo.html_id=477332'"/>
