...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Other-political-staff/state-secretary-guri-storvold.html_id=582284'"/>
...
<xsl:variable name="para_nno" select="'statssekretar-guri-storvold.html_id=582284'"/>
<xsl:variable name="para_nob" select="'statssekretar-guri-storvold.html_id=582284'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-guri-storvold.html_id=582284'"/>
