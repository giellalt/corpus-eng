...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Other-political-staff/State-Secretary-Terje-Moland-Pedersen.html_id=1695'"/>
...
<xsl:variable name="para_nno" select="'statssekretar-terje-moland-pedersen.html_id=1695'"/>
<xsl:variable name="para_nob" select="'statssekretar_terje_moland_pedersen.html_id=1695'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-terje-moland-pedersen.html_id=1695'"/>
