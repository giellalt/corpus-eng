...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2009/norway-presents-new-measures-for-industr.html_id=545250'"/>
...
<xsl:variable name="para_nob" select="'nye-tiltak-for-naringsliv-og-husholdning.html_id=545250'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oa-doaibmabijut-ealahusaide-ja-dallodoal.html_id=545250'"/>
