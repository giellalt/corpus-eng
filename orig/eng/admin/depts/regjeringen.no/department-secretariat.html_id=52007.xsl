...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management/Department-Secretariat.html_id=52007'"/>
...
<xsl:variable name="para_nob" select="'avdelingssekretariatet.html_id=52007'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ossodatallingoddi.html_id=52007'"/>
