...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/press-centre.html_id=794'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=794'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=794'"/>
