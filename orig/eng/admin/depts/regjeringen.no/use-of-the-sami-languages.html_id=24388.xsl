...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/use-of-the-sami-languages.html_id=24388'"/>
...
<xsl:variable name="para_nob" select="'bruk_av_samisk_sprak.html_id=24388'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'samegiela-geavaheapmi.html_id=24388'"/>
