...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc.html_id=439279'"/>
...
<xsl:variable name="para_nno" select="'dok.html_id=439279'"/>
<xsl:variable name="para_nob" select="'dok.html_id=439279'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dok.html_id=439279'"/>
