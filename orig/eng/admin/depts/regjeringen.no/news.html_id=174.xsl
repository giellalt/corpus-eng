...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/whats-new/news.html_id=174'"/>
...
<xsl:variable name="para_nno" select="'nyheiter.html_id=174'"/>
<xsl:variable name="para_nob" select="'nyheter.html_id=174'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oasat.html_id=174'"/>
