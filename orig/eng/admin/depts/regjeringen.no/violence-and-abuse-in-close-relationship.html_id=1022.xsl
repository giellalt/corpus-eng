...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Violence-and-abuse-in-close-relationship.html_id=1022'"/>
...
<xsl:variable name="para_nno" select="'vald-og-overgrep-i-nare-relasjonar.html_id=1022'"/>
<xsl:variable name="para_nob" select="'vold_i_nare_relasjoner.html_id=1022'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'veahkavaldimat-ja-veahkavalddalavuoat-la.html_id=1022'"/>
