...
<xsl:variable name="filename" select="'http://regjeringen.no/en/Topics_a-z.html_id=223486'"/>
...
<xsl:variable name="para_nno" select="'tema_a-aa.html_id=223486'"/>
<xsl:variable name="para_nob" select="'tema_a-aa.html_id=223486'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fadda_a-aa.html_id=223486'"/>
