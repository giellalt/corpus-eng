...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/human-rights.html_id=1160'"/>
...
<xsl:variable name="para_nob" select="'menneskerettigheter.html_id=1160'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mr_samisk.html_id=1160'"/>
