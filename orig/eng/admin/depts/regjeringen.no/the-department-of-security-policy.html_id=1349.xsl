...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/The-Department-of-Security-Policy.html_id=1349'"/>
...
<xsl:variable name="para_nno" select="'avdeling-for-tryggleikspolitikk.html_id=1349'"/>
<xsl:variable name="para_nob" select="'avdeling_for_sikkerhetspolitikk.html_id=1349'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sihkkarvuoapolitihka-ossodat.html_id=1349'"/>
