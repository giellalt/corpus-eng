...
<xsl:variable name="filename" select="'http://regjeringen.no/en/the-government/the-government-at-work/government-conferences.html_id=270335'"/>
...
<xsl:variable name="para_nno" select="'regjeringskonferanse.html_id=270335'"/>
<xsl:variable name="para_nob" select="'regjeringskonferanse.html_id=270335'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehuskonferansa.html_id=270335'"/>
