...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Business-and-industry.html_id=926'"/>
...
<xsl:variable name="para_nno" select="'naringsliv.html_id=926'"/>
<xsl:variable name="para_nob" select="'naringsliv.html_id=926'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ealahuseallin.html_id=926'"/>
