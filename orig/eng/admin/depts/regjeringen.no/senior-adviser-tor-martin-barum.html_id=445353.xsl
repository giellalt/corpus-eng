...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/information-department/Senior-Adviser-Tor-MArtin-Barum.html_id=445353'"/>
...
<xsl:variable name="para_nno" select="'seniorradgivar-tor-martin-barum.html_id=445353'"/>
<xsl:variable name="para_nob" select="'tor-martin-barum.html_id=445353'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'seniorraeaddi-tor-martin-barum.html_id=445353'"/>
