...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/senior-administrative-staff-2.html_id=856'"/>
...
<xsl:variable name="para_nno" select="'admnistrativ-leiing.html_id=856'"/>
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=856'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-njunugodd.html_id=856'"/>
