...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-aquaculture-seafood-and-ma/Director-General--Department-of-Aquaculture-Seafood-and-Markets.html_id=1556'"/>
...
<xsl:variable name="para_nno" select="'ekspedisjonssjef---avdeling-for-havbruk-.html_id=1556'"/>
<xsl:variable name="para_nob" select="'ekspedisjonssjef_-_avdeling_for_havbruk_.html_id=1556'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda--mearraavkkastallan-mearrabiebmu-ja-markan-.html_id=1556'"/>
