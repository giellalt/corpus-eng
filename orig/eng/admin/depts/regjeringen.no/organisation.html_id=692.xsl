...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation.html_id=692'"/>
...
<xsl:variable name="para_nno" select="'organisasjon.html_id=692'"/>
<xsl:variable name="para_nob" select="'org.html_id=692'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisasvdna.html_id=692'"/>
