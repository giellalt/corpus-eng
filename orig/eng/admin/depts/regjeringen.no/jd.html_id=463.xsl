...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd.html_id=463'"/>
...
<xsl:variable name="para_nno" select="'jd.html_id=463'"/>
<xsl:variable name="para_nob" select="'jd.html_id=463'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'jd.html_id=463'"/>
