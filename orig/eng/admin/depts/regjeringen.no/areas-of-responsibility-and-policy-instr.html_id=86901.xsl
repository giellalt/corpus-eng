...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/labour-market-policy/midtspalte/areas-of-responsibility-and-policy-instr.html_id=86901'"/>
...
<xsl:variable name="para_nob" select="'ansvarsfordeling.html_id=86901'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovddasvastadussuorggit-ja-vaikkuhangaskaoamit.html_id=86901'"/>
