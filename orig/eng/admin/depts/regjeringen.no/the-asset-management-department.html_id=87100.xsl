...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/the-asset-management-department.html_id=87100'"/>
...
<xsl:variable name="para_nno" select="'avdeling-for-formuesforvaltning-aff.html_id=87100'"/>
<xsl:variable name="para_nob" select="'formuesforvaltning.html_id=87100'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'opmodagaid-halddaanossodat-.html_id=87100'"/>
