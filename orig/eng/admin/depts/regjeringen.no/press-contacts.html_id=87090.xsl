...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/press-contacts.html_id=87090'"/>
...
<xsl:variable name="para_nno" select="'pressekontaktar.html_id=87090'"/>
<xsl:variable name="para_nob" select="'pressekontakter.html_id=87090'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassaoktavuoat.html_id=87090'"/>
