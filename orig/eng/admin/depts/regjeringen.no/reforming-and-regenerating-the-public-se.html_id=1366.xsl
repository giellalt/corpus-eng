...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Reforming-and-regenerating-the-public-se.html_id=1366'"/>
...
<xsl:variable name="para_nob" select="'fornying_av_offentlig_sektor.html_id=1366'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'almmola-suorggi-oasmahttin.html_id=1366'"/>
