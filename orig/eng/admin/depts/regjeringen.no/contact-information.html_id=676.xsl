...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/contact-information.html_id=676'"/>
...
<xsl:variable name="para_nob" select="'kontakt.html_id=676'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oktavuohtadiehtojuohkin.html_id=676'"/>
