...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/high-north.html_id=1154'"/>
...
<xsl:variable name="para_nob" select="'nordomradeportalen.html_id=450629'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nord_samisk.html_id=1154'"/>
