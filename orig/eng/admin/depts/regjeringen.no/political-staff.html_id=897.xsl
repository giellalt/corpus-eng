...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff.html_id=897'"/>
...
<xsl:variable name="para_nno" select="'politiske-medarbeidarar.html_id=897'"/>
<xsl:variable name="para_nob" select="'politisk_ledelse.html_id=897'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-mieldebargit.html_id=897'"/>
