...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/The-Guarantee-Fund-for-Fishermen.html_id=163538'"/>
...
<xsl:variable name="para_nno" select="'garantikassa-for-fiskarane.html_id=163538'"/>
<xsl:variable name="para_nob" select="'garantikassen-for-fiskerne.html_id=163538'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guolasteddjiid-dahkaduskassa-.html_id=163538'"/>
