...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/magnhild-meltveit-kleppa.html_id=582231'"/>
...
<xsl:variable name="para_nno" select="'samferdselsminister-magnhild-meltveit-kl.html_id=582231'"/>
<xsl:variable name="para_nob" select="'magnhild-meltveit-kleppa.html_id=582231'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtalusministtar-magnhild-meltveit-klep.html_id=582231'"/>
