...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation/accreditation-of-election-observers.html_id=573464'"/>
...
<xsl:variable name="para_nob" select="'akkreditering-av-valgobservatorer.html_id=573464'"/>
