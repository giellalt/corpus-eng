...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/picture-archive.html_id=533'"/>
...
<xsl:variable name="para_nno" select="'biletarkiv.html_id=533'"/>
<xsl:variable name="para_nob" select="'bildearkiv.html_id=533'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvaarkiiva.html_id=533'"/>
