...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd.html_id=257'"/>
...
<xsl:variable name="para_nno" select="'fkd.html_id=257'"/>
<xsl:variable name="para_nob" select="'fkd.html_id=257'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fkd.html_id=257'"/>
