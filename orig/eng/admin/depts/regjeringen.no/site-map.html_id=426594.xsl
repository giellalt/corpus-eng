...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Site-Map.html_id=426594'"/>
...
<xsl:variable name="para_nno" select="'426594.html_id=426594'"/>
<xsl:variable name="para_nob" select="'nettstedskart.html_id=426594'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'neahttakarta-.html_id=426594'"/>
