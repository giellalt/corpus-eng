...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election.html_id=538253'"/>
...
<xsl:variable name="para_nno" select="'stortingsval.html_id=538253'"/>
<xsl:variable name="para_nob" select="'stortingsvalg.html_id=538253'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ddd.html_id=538253'"/>
