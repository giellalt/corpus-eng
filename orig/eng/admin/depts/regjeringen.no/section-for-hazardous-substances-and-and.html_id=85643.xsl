...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut/section-for-hazardous-substances-and-and.html_id=85643'"/>
...
<xsl:variable name="para_nob" select="'kjemikalier_og_avfall.html_id=85643'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kemikala--ja-doapparsekuvdna.html_id=85643'"/>
