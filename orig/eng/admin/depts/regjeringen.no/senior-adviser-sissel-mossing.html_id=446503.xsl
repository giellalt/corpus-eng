...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit/senior-adviser-sissel-mossing.html_id=446503'"/>
...
<xsl:variable name="para_nob" select="'sim.html_id=446503'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'seniorraeaddi-sissel-mossing.html_id=446503'"/>
