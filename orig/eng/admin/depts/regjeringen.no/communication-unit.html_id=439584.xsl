...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/communication-unit.html_id=439584'"/>
...
<xsl:variable name="para_nno" select="'kommunikasjonseininga.html_id=439584'"/>
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html_id=439584'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahallanovttadat.html_id=439584'"/>
