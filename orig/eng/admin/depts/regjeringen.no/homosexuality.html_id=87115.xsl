...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/homosexuality.html_id=87115'"/>
...
<xsl:variable name="para_nob" select="'homofile-og-lesbiske.html_id=87115'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lesbbat-homofiilat-bifiillat-transsat-.html_id=87115'"/>
