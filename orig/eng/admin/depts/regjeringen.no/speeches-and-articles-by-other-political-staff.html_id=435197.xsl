...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Other-political-staff/Vidar-Ulriksen--Secretary-of-State/Speeches-and-articles-by-other-political-staff.html_id=435197'"/>
...
<xsl:variable name="para_nob" select="'taler_artikler-2.html_id=435197'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sartnit-ja-artihkkalat.html_id=435197'"/>
