...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut.html_id=1175'"/>
...
<xsl:variable name="para_nob" select="'forurensningssaker.html_id=1175'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nuoskkidanaiid-ossodat.html_id=1175'"/>
