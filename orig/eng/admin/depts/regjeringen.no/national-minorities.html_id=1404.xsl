...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/national-minorities.html_id=1404'"/>
...
<xsl:variable name="para_nno" select="'nasjonale-minoritetar.html_id=1404'"/>
<xsl:variable name="para_nob" select="'nasjonale_minoriteter.html_id=1404'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nationala-unnitlogut.html_id=1404'"/>
