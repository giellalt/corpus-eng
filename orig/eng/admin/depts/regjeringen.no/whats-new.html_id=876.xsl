...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new.html_id=876'"/>
...
<xsl:variable name="para_nno" select="'aktuelt.html_id=876'"/>
<xsl:variable name="para_nob" select="'aktuelt.html_id=876'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'aktuelt.html_id=876'"/>
