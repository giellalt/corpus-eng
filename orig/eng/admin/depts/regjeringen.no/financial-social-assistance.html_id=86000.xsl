...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/welfare-policy/midtspalte/financial-social-assistance.html_id=86000'"/>
...
<xsl:variable name="para_nob" select="'okonomisk_sosialhjelp.html_id=86000'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomala-sosialaveahkki.html_id=86000'"/>
