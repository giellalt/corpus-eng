...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/nordic-sami-cooperation/on-nordic-sami-cooperation.html_id=87011'"/>
...
<xsl:variable name="para_nob" select="'om-nordisk-samisk-samarbeid.html_id=87011'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'davviriikkala-sami-ovttasbargu.html_id=87011'"/>
