...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Competition-policy.html_id=1363'"/>
...
<xsl:variable name="para_nob" select="'konkurransepolitikk.html_id=1363'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gilvalanpolitihkka.html_id=1363'"/>
