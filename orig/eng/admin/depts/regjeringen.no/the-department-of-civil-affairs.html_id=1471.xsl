...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/The-Department-of-Civil-Affairs.html_id=1471'"/>
...
<xsl:variable name="para_nno" select="'sivilavdelinga.html_id=1471'"/>
<xsl:variable name="para_nob" select="'sivilavdelingen.html_id=1471'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'siviilaossodat-.html_id=1471'"/>
