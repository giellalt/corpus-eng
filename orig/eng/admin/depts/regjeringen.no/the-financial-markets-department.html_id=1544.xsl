...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/The-Financial-Markets-Department.html_id=1544'"/>
...
<xsl:variable name="para_nno" select="'finansavdelinga.html_id=1544'"/>
<xsl:variable name="para_nob" select="'finansavdelingen.html_id=1544'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ruhtadanossodat.html_id=1544'"/>
