...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy.html_id=1403'"/>
...
<xsl:variable name="para_nob" select="'samepolitikk.html_id=1403'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'samepolitihkka.html_id=1403'"/>
