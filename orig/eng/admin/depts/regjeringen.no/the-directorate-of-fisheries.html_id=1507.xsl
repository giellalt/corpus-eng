...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Subordinate-agencies-and-institutions/The-Directorate-of-Fisheries.html_id=1507'"/>
...
<xsl:variable name="para_nno" select="'fiskeridirektoratet.html_id=1507'"/>
<xsl:variable name="para_nob" select="'fiskeridirektoratet.html_id=1507'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guolastusdirektorahta.html_id=1507'"/>
