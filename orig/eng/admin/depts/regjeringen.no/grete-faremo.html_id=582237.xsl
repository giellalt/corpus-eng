...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/grete-faremo.html_id=582237'"/>
...
<xsl:variable name="para_nno" select="'grete-faremo.html_id=582237'"/>
<xsl:variable name="para_nob" select="'grete-faremo.html_id=582237'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'suodjalusministtar-grete-faremo.html_id=582237'"/>
