...
<!-- Add the locations of the parallel files to the variables-->
  ...
  <xsl:variable name="para_nno" select="'statsminister-jens-stoltenberg.html_id=1597'"/>
  <xsl:variable name="para_nob" select="'statsminister_jens_stoltenberg.html_id=1597'"/>
  <xsl:variable name="para_sma" select="''"/>
  <xsl:variable name="para_sme" select="'stahtaministtar-jens-stoltenberg.html_id=1597'"/>
