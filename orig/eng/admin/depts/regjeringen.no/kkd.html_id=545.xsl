...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd.html_id=545'"/>
...
<xsl:variable name="para_nno" select="'kud.html_id=545'"/>
<xsl:variable name="para_nob" select="'kud.html_id=545'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kkd.html_id=545'"/>
