...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-pension-policy.html_id=975'"/>
...
<xsl:variable name="para_nno" select="'pensjonsavdelinga.html_id=975'"/>
<xsl:variable name="para_nob" select="'pa.html_id=975'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ealahatossodat.html_id=975'"/>
