...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/innovation-norway-.html_id=168036'"/>
...
<xsl:variable name="para_nno" select="'innovasjon-noreg.html_id=168036'"/>
<xsl:variable name="para_nob" select="'innovasjon-norge.html_id=168036'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'innovauvdna-norga-.html_id=168036'"/>
