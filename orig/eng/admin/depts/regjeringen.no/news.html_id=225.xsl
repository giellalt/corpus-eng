...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/News/news.html_id=225'"/>
...
<xsl:variable name="para_nno" select="'nyheiter.html_id=225'"/>
<xsl:variable name="para_nob" select="'nyheter.html_id=225'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nyheter.html_id=225'"/>
