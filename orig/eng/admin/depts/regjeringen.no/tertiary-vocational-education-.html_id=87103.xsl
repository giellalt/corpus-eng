...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/Tertiary-Vocational-Education-.html_id=87103'"/>
...
<xsl:variable name="para_nob" select="'fagskoleutdanning.html_id=87103'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fagaskuvlaoahppu.html_id=87103'"/>
