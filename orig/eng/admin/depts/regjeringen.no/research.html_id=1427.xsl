...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/research.html_id=1427'"/>
...
<xsl:variable name="para_nob" select="'forskning.html_id=1427'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dutkan.html_id=1427'"/>
