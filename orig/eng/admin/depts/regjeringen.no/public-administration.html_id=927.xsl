...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Public-administration.html_id=927'"/>
...
<xsl:variable name="para_nno" select="'offentleg-forvaltning.html_id=927'"/>
<xsl:variable name="para_nob" select="'offentlig_forvaltning.html_id=927'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'almmola-halddahus.html_id=927'"/>
