...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/Other-political-staff/state-secretary-roger-ingebrigtsen.html_id=610369'"/>
...
<xsl:variable name="para_nno" select="'statssekretar-roger-ingebrigtsen.html_id=610369'"/>
<xsl:variable name="para_nob" select="'statssekretar-roger-ingebrigtsen.html_id=610369'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-roger-ingebrigtsen.html_id=610369'"/>
