...
<xsl:variable name="filename" select="'http://regjeringen.no/en/whatsnew/Calendar.html_id=1330'"/>
...
<xsl:variable name="para_nno" select="'kalender.html_id=1330'"/>
<xsl:variable name="para_nob" select="'kalender.html_id=1330'"/>
