...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects.html_id=506'"/>
...
<xsl:variable name="para_nno" select="'tema.html_id=506'"/>
<xsl:variable name="para_nob" select="'tema.html_id=506'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fadda.html_id=506'"/>
