...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/upper-secondary-education.html_id=87102'"/>
...
<xsl:variable name="para_nob" select="'videregaende-opplaring.html_id=87102'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'joatkkaoahpahus.html_id=87102'"/>
