...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister.html_id=445755'"/>
...
<xsl:variable name="para_nno" select="'statsminister.html_id=445755'"/>
<xsl:variable name="para_nob" select="'statsministerens-kontor.html_id=445755'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaministtar.html_id=445755'"/>
