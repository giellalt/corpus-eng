...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics.html_id=300'"/>
...
<xsl:variable name="para_nno" select="'tema.html_id=300'"/>
<xsl:variable name="para_nob" select="'tema.html_id=300'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'tema.html_id=300'"/>
