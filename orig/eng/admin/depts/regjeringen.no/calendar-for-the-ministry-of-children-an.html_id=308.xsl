...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Whats-new/calendar-for-the-ministry-of-children-an.html_id=308'"/>
...
<xsl:variable name="para_nno" select="'kalender.html_id=308'"/>
<xsl:variable name="para_nob" select="'kalender.html_id=308'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'manaid--ja-dassearvodepartemeantta-kaleanddar.html_id=308'"/>
