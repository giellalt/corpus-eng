...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Documents/Reports-and-plans/Reports.html_id=1874'"/>
...
<xsl:variable name="para_nno" select="'rapportar.html_id=1874'"/>
<xsl:variable name="para_nob" select="'rapporter.html_id=1874'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'rapporter.html_id=1874'"/>
