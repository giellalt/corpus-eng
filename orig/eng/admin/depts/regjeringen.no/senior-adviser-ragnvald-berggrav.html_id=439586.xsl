...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/communication-unit/senior-adviser-ragnvald-berggrav.html_id=439586'"/>
...
<xsl:variable name="para_nob" select="'seniorradgiver.html_id=439586'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'senior-gulahallanravvejeaddji-ragnvald-berggrav.html_id=439586'"/>
