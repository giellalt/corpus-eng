...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/development-of-companies-and-business-en.html_id=526842'"/>
...
<xsl:variable name="para_nob" select="'utvikling-av-bedrifter-og-naringsmiljo.html_id=526842'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fitnodagaid-ja-ealahusdoaimmaid-ovdanahttin.html_id=526842'"/>
