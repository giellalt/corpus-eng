...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/the-department-of-migration.html_id=589391'"/>
...
<xsl:variable name="para_nno" select="'innvandringsavdelinga.html_id=589391'"/>
<xsl:variable name="para_nob" select="'innvandringsavdelingen.html_id=589391'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sisafarrenossodat-.html_id=589391'"/>
