...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md.html_id=668'"/>
...
<xsl:variable name="para_nno" select="'md.html_id=668'"/>
<xsl:variable name="para_nob" select="'md.html_id=668'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'md.html_id=668'"/>
