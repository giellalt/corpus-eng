...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/Laws/Acts/the-sami-act-.html_id=449701'"/>
...
<xsl:variable name="para_nob" select="'sameloven---samel.html_id=449701'"/>
