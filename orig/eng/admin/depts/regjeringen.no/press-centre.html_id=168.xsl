...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/press-centre.html_id=168'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=168'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=168'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassaguovdda.html_id=168'"/>
