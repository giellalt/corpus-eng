...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/Department-for-the-Arts.html_id=590158'"/>
...
<xsl:variable name="para_nno" select="'kunstavdelinga.html_id=590158'"/>
<xsl:variable name="para_nob" select="'kunstavdelingen.html_id=590158'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'daiddaossodat.html_id=590158'"/>
