...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/the-state-agency-for-the-recovery-of-fin.html_id=270406'"/>
...
<xsl:variable name="para_nno" select="'statens-innkrevingssentral.html_id=270406'"/>
<xsl:variable name="para_nob" select="'statens-innkrevingssentral.html_id=270406'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahta-gaibidanguovdda.html_id=270406'"/>
