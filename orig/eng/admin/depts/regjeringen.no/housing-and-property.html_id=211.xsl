...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/housing-and-property.html_id=211'"/>
...
<xsl:variable name="para_nno" select="'bustad-og-eigedom.html_id=211'"/>
<xsl:variable name="para_nob" select="'bolig_og_eiendom.html_id=211'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'viessu-ja-opmodat.html_id=211'"/>
