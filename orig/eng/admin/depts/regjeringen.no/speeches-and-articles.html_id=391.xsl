...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/Speeches-and-articles.html_id=391'"/>
...
<xsl:variable name="para_nno" select="'taler-og-artiklar.html_id=391'"/>
<xsl:variable name="para_nob" select="'taler_artikler.html_id=391'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'taler_artikler.html_id=391'"/>
