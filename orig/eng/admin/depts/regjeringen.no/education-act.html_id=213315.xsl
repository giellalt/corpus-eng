...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/Laws/Acts/education-act.html_id=213315'"/>
...
<xsl:variable name="para_nob" select="'opplaringsloven.html_id=213315'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lahka-vuooskuvlla-ja-joatkkaoahpahusa-bi.html_id=213315'"/>
