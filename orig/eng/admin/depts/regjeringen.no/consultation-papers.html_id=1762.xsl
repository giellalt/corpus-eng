...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/consultation-papers.html_id=1762'"/>
...
<xsl:variable name="para_nno" select="'rundskriv.html_id=1762'"/>
<xsl:variable name="para_nob" select="'rundskriv.html_id=1762'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtoallosat-.html_id=1762'"/>
