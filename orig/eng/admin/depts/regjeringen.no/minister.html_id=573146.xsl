...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/Speeches-and-articles/minister.html_id=573146'"/>
...
<xsl:variable name="para_nno" select="'ministaren.html_id=573146'"/>
<xsl:variable name="para_nob" select="'ministeren.html_id=573146'"/>
