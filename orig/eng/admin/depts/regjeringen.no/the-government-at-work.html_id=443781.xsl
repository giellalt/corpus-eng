...
<xsl:variable name="filename" select="'http://regjeringen.no/en/the-government/the-government-at-work.html_id=443781'"/>
...
<xsl:variable name="para_nno" select="'slik-arbeider-regjeringa.html_id=443781'"/>
<xsl:variable name="para_nob" select="'regjeringen-i-arbeid.html_id=443781'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehusa-bargu.html_id=443781'"/>
