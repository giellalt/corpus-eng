...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/the-financial-supervisory-authority.html_id=270404'"/>
...
<xsl:variable name="para_nno" select="'kredittilsynet.html_id=270404'"/>
<xsl:variable name="para_nob" select="'kredittilsynet.html_id=270404'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kredihttabearraigeahu.html_id=270404'"/>
