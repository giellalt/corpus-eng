...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Press-Centre/Picture-Archive.html_id=286'"/>
...
<xsl:variable name="para_nno" select="'biletarkiv.html_id=286'"/>
<xsl:variable name="para_nob" select="'bildearkiv.html_id=286'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka.html_id=286'"/>
