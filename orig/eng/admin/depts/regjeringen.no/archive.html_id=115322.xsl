...
<xsl:variable name="filename" select="'http://regjeringen.no/en/archive.html_id=115322'"/>
...
<xsl:variable name="para_nno" select="'dokumentarkiv.html_id=115322'"/>
<xsl:variable name="para_nob" select="'dokumentarkiv.html_id=115322'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dokumeantavuorka.html_id=115322'"/>
