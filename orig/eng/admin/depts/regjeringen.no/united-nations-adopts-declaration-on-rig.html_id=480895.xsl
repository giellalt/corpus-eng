...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/press-centre/press-releases/2007/United-Nations-adopts-Declaration-on-Rig.html_id=480895'"/>
...
<xsl:variable name="para_nob" select="'111.html_id=480895'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eamialbmotjulggatus-maid-ona-valdooahkki.html_id=480895'"/>
