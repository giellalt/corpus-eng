...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Other-political-staff/secretary-of-state-dag-henrik-sandbakken.html_id=1505'"/>
...
<xsl:variable name="para_nob" select="'statssekretar_sandbakken.html_id=1505'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-dag-henrik-sandbakken.html_id=1505'"/>
