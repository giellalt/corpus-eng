...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Other-Political-Staff.html_id=238'"/>
...
<xsl:variable name="para_nno" select="'anna-politisk-leiing-.html_id=238'"/>
<xsl:variable name="para_nob" select="'politisk_ledelse.html_id=238'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eara-politihkala-njunnoat.html_id=238'"/>
