...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/Subjects/lovarbeid/Legislative-procedure.html_id=445792'"/>
...
<xsl:variable name="para_nob" select="'gangen-i-lovgivningsarbeidet.html_id=445792'"/>
