...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Documents/Acts-and-regulations/Acts-and-regulations.html_id=293'"/>
...
<xsl:variable name="para_nno" select="'lover.html_id=293'"/>
<xsl:variable name="para_nob" select="'lover.html_id=293'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-.html_id=293'"/>
