...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/minister-of-finance-sigbjorn-johnsen.html_id=582364'"/>
...
<xsl:variable name="para_nno" select="'finansminister-sigbjorn-johnsen.html_id=582364'"/>
<xsl:variable name="para_nob" select="'finansminister-sigbjorn-johnsen.html_id=582364'"/>
