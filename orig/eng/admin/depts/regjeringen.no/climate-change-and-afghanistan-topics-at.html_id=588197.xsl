...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2009/climate-change-and-afghanistan-topics-at.html_id=588197'"/>
...
<xsl:variable name="para_nob" select="'klima-og-afghanistan-sentrale-tema-i-sto.html_id=588197'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dalkkadat-ja-afghanistana-ledje-guovdili.html_id=588197'"/>
