...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/Rescue-and-Emergency-Planning-Department.html_id=1470'"/>
...
<xsl:variable name="para_nno" select="'rednings--og-beredskapsavdelinga.html_id=1470'"/>
<xsl:variable name="para_nob" select="'rednings-_og_beredskapsshyavdelingen_.html_id=1470'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gadjun--ja-valmmastanossodat-.html_id=1470'"/>
