...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/kampanjer/the-coordination-reform/team-of-experts.html_id=524785'"/>
...
<xsl:variable name="para_nob" select="'ekspertgruppa.html_id=524785'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'medlemmene-i-ekspertgruppa.html_id=524785'"/>
