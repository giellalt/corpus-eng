...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects.html_id=423'"/>
...
<xsl:variable name="para_nno" select="'tema.html_id=423'"/>
<xsl:variable name="para_nob" select="'tema.html_id=423'"/>
