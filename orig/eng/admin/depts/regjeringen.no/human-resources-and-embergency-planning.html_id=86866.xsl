...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/administrative-department/human-resources-and-embergency-planning.html_id=86866'"/>
...
<xsl:variable name="para_nob" select="'personal-og-beredskap-pb.html_id=86866'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargit-ja-gearggusvuohta.html_id=86866'"/>
