...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/the-ministry-of-agriculture-and-food.html_id=632'"/>
...
<xsl:variable name="para_nno" select="'om-departementet.html_id=632'"/>
<xsl:variable name="para_nob" select="'dep.html_id=632'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantta-birra.html_id=632'"/>
