...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd.html_id=586'"/>
...
<xsl:variable name="para_nno" select="'kd.html_id=586'"/>
<xsl:variable name="para_nob" select="'kd.html_id=586'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kd.html_id=586'"/>
