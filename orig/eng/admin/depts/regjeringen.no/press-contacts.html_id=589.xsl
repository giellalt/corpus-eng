...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/press-contacts.html_id=589'"/>
...
<xsl:variable name="para_nno" select="'pressesenter.html_id=589'"/>
<xsl:variable name="para_nob" select="'pressesenter.html_id=589'"/>
