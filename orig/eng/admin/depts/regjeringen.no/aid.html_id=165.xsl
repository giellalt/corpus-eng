...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid.html_id=165'"/>
...
<xsl:variable name="para_nno" select="'aid.html_id=165'"/>
<xsl:variable name="para_nob" select="'ad.html_id=165'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'aid.html_id=165'"/>
