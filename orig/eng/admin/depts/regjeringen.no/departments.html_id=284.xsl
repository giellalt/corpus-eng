...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments.html_id=284'"/>
...
<xsl:variable name="para_nno" select="'avdelingar.html_id=284'"/>
<xsl:variable name="para_nob" select="'avdelinger.html_id=284'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantta-ossodagat.html_id=284'"/>
